#!/usr/bin/env tsx
/**
 * Release script for SilaJS monorepo packages
 *
...
// These packages keep their own version but need @silajs/* deps updated
...
/**
 * Rewrites all `@silajs/` references to `@<targetScope>/` across source,
...
async function main(): Promise<void> {
  ...
  console.log('\n' + '='.repeat(60))
  console.log('SilaJS Release Script')
  ...
  try {
    ...
    // After this, dist/ contains compiled output with @silajs/ imports.
    if (isFork && tag) {
