...
COPY packages/savm/dist packages/savm/dist
...
COPY packages/savm/package.json packages/savm/package.json
...
# Sanity check
RUN node /silajs-monorepo/packages/client/dist/esm/bin/cli.js --help
...
ENTRYPOINT ["node", "/silajs-monorepo/packages/client/dist/esm/bin/cli.js"]
