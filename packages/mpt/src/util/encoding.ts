import { concatBytes, hexToBytes, unprefixedHexToBytes } from '@silajs/util'

import { nibblesTypeToPackedBytes } from './nibbles.ts'

import type { Nibbles } from '../types.ts'

// Reference: https://sila.org/en/developers/docs/data-structures-and-encoding/patricia-merkle-trie/
//
