...
[@silajs/mpt](../README.md) / byteTypeToNibbleType

# Function: byteTypeToNibbleType()

> **byteTypeToNibbleType**(`key`): [`Nibbles`](../type-aliases/Nibbles.md)

Defined in: [packages/mpt/src/util/encoding.ts:131](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/mpt/src/util/encoding.ts#L131)
