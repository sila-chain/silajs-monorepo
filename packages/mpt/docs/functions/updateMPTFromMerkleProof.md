...
[@silajs/mpt](../README.md) / updateMPTFromMerkleProof
...
Defined in: [packages/mpt/src/proof/proof.ts:56](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/mpt/src/proof/proof.ts#L56)
...
An (SIP-1186)[https://sips.sila.org/SIPS/sip-1186] proof to update the trie from.
