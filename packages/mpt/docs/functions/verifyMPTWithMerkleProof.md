...
[@silajs/mpt](../README.md) / verifyMPTWithMerkleProof
...
Defined in: [packages/mpt/src/proof/proof.ts:96](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/mpt/src/proof/proof.ts#L96)
...
an SIP-1186 proof to verify the key against
