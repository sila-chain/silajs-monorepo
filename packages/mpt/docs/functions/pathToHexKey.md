...
[@silajs/mpt](../README.md) / pathToHexKey

# Function: pathToHexKey()

> **pathToHexKey**(`path`, `extension`, `retType`): `Uint8Array`

Defined in: [packages/mpt/src/util/encoding.ts:150](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/mpt/src/util/encoding.ts#L150)
