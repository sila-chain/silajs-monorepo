...
[@silajs/mpt](../README.md) / verifyMerkleRangeProof
...
Defined in: [packages/mpt/src/proof/range.ts:420](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/mpt/src/proof/range.ts#L420)
