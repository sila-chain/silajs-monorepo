...
for (const keyPrefix of [undefined, hexToBytes('0x1234')]) {
  for (const cacheSize of [0, 100]) {
    ...
    describe('it should create the genesis state root from sila', () => {
      it('should work', async () => {
    ...
    describe('setting back state root (deleteFromDB)', () => {
      it('should work', async () => {
         ...
         * Reasoning from https://sila.org/en/developers/docs/data-structures-and-encoding/patricia-merkle-trie/:
