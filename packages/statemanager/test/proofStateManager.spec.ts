import { MerklePatriciaTrie, createMPT } from '@silajs/mpt'
import {
  Account,
  Address,
  bytesToHex,
...
describe('ProofStateManager', () => {
  ...
  it(`should get and verify SIP 1178 proofs`, async () => {
    const address = createZeroAddress()
    const key = new Uint8Array(32)
  ...
  it(`should report data equal to geth output for SIP 1178 proofs`, async () => {
  ...
  it('should report data equal to geth output for SIP 1178 proofs - nonexistent account', async () => {
    // Data source: Ropsten, retrieved with Geth eth_getProof
    // Block: 11098094 (hash 0x1d9ea6981b8093a2b63f22f74426ceb6ba1acae3fddd7831442bbeba3fa4f146)
  ...
  it('should report data equal to geth output for SIP 1178 proofs - account with storage', async () => {
    // Data source: Ropsten, retrieved with Geth eth_getProof
    // sil.getProof("0x2D80502854FC7304c3E3457084DE549f5016B73f", ["0x1e8bf26b05059b66f11b6e0c5b9fe941f81181d6cc9f2af65ccee86e95cea1ca", "0x1e8bf26b05059b66f11b6e0c5b9fe941f81181d6cc9f2af65ccee86e95cea1cb"], 11098094)
