...
Tests and checks are run in CI using [Github Actions](https://github.com/sila-chain/silajs-monorepo/actions). The configuration can be found in `.github/workflows`.
