...
[@silajs/statemanager](../README.md) / CODEHASH\_PREFIX

# Variable: CODEHASH\_PREFIX

> `const` **CODEHASH\_PREFIX**: `Uint8Array`\<`ArrayBufferLike`\>

Defined in: [merkleStateManager.ts:45](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/statemanager/src/merkleStateManager.ts#L45)
