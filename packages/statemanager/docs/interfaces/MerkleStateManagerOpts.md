...
[@silajs/statemanager](../README.md) / MerkleStateManagerOpts

# Interface: MerkleStateManagerOpts

Defined in: [types.ts:32](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/statemanager/src/types.ts#L32)
...
Defined in: [types.ts:64](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/statemanager/src/types.ts#L64)
...
Defined in: [types.ts:14](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/statemanager/src/types.ts#L14)
...
Defined in: [types.ts:43](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/statemanager/src/types.ts#L43)
...
Defined in: [types.ts:55](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/statemanager/src/types.ts#L55)
...
Defined in: [types.ts:36](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/statemanager/src/types.ts#L36)
