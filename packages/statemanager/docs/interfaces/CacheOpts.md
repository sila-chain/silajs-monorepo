...
[@silajs/statemanager](../README.md) / CacheOpts

# Interface: CacheOpts

Defined in: [cache/types.ts:8](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/statemanager/src/cache/types.ts#L8)
...
Defined in: [cache/types.ts:19](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/statemanager/src/cache/types.ts#L19)
...
Defined in: [cache/types.ts:31](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/statemanager/src/cache/types.ts#L31)
