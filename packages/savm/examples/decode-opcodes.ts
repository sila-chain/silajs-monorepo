...
//
// 1. Takes binary SAVM code and decodes it into opcodes

import { Common, Hardfork, SilaMainnet } from '@silajs/common'
import { getOpcodesForHF, paramsEVM } from '@silajs/savm'
import { bytesToHex, hexToBytes } from '@silajs/util'

const common = new Common({ chain: SilaMainnet, hardfork: Hardfork.Istanbul, params: paramsEVM })
