...
[@silajs/savm](../README.md) / CustomPrecompile

# Type Alias: CustomPrecompile

> **CustomPrecompile** = [`AddPrecompile`](AddPrecompile.md) \| [`DeletePrecompile`](DeletePrecompile.md)

Defined in: [precompiles/index.ts:281](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/savm/src/precompiles/index.ts#L281)
