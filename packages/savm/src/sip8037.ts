import { BIGINT_0 } from '@silajs/util'
...
/**
 * Minimal shape of a tx needed to split intrinsic gas into the SIP-8037
 * regular/state dimensions. Avoids a `@silajs/tx` import cycle here.
 */
interface IntrinsicDimensionsTx {
  ...
  // SIP-7702 (type 4) txs expose an authorization list.
...
export function computeIntrinsicGasDimensions8037(
  ...
  // tx/capabilities/sip7702.ts) adds `authCount * perEmptyAccountCost` to
  // the regular intrinsic. Under SIP-8037 perEmptyAccountCost = 0 and the
