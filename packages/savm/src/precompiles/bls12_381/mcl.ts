...
export class MCLBLS implements EVMBLSInterface {
  ...
  pairingCheck(input: Uint8Array): Uint8Array {
    ...
    // reference (Nethermind): https://github.com/NethermindEth/nethermind/blob/374b036414722b9c8ad27e93d64840b8f63931b9/src/Nethermind/Nethermind.Savm/Precompiles/Bls/Mcl/PairingPrecompile.cs#L93
    let GT
