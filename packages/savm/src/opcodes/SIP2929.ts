import { BIGINT_0, bytesToHex } from '@silajs/util'
...
/**
 * Warms an address (adds to SIP-2929 accessed addresses set).
...
/**
 * Adds address to BAL (Block Access List) for SIP-7928.
 * Call this AFTER verifying you have enough gas for the access.
 *
 * @param {RunState} runState
 * @param {Uint8Array} address
 ...
 * is warm/cold. (SIP 2929)
 *
 * This is a convenience function that combines getAddressAccessCost + warmAddress.
 * For fine-grained control (e.g., SIP-7928 BAL with OOG checks), use the
...
/**
 * Adjusts cost of SSTORE_RESET_GAS or SLOAD (aka sstorenoop) (SIP-2200) downward when storage
