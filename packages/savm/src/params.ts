import type { ParamsDict } from '@silajs/common'
import { SYSTEM_ADDRESS } from '@silajs/util'
...
export const paramsEVM: ParamsDict = {
  ...
  1: {
    ...
    slotnumGas: 2, // Base fee of the SLOTNUM opcode (SIP-7843)
...
.  */
  1716: {
    // gasPrices
    netSstoreNoopGas: null, // Removed along SIP-1283
    netSstoreInitGas: null, // Removed along SIP-1283
    netSstoreCleanGas: null, // Removed along SIP-1283
    netSstoreDirtyGas: null, // Removed along SIP-1283
    netSstoreClearRefundGas: null, // Removed along SIP-1283
    netSstoreResetRefundGas: null, // Removed along SIP-1283
    netSstoreResetClearRefundGas: null, // Removed along SIP-1283
  },
  /**
...
.  */
  7939: {
    // gasPrices
    clzGas: 5, // Base fee of the CLZ opcode (matching MUL as per SIP-7939)
  },
  /**
  ...
  7954: {
    // savm
    maxCodeSize: 32768, // SIP-7954: Maximum length of contract code (raised from 24 KiB)
    maxInitCodeSize: 65536, // SIP-7954: Maximum length of initialization code (raised from 48 KiB)
  },
  /**
   * State Creation Gas Cost Increase
   * Regular-gas portions of the state-creation cost overrides per the SIP-8037 parameter table,
  ...
  8037: {
    ...
    sstoreInitEIP2200Gas: 2900, // SIP-2200 path uses this name for the create-slot regular cost; align with sstoreSetGas under 8037
    ...
    stateBytesPerAuthBase: 23, // Bytes accounted per SIP-7702 authorization base
