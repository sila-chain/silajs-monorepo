...
[@silajs/tx](../README.md) / TransactionInterface

# Interface: TransactionInterface\<T\>

Defined in: [types.ts:211](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/tx/src/types.ts#L211)

## Extended by

- [`LegacyTxInterface`](LegacyTxInterface.md)
- [`SIP2718CompatibleTx`](SIP2718CompatibleTx.md)
...
Defined in: [types.ts:231](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/tx/src/types.ts#L231)
