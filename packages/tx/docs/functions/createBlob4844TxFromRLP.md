...
[@silajs/tx](../README.md) / createBlob4844TxFromRLP

# Function: createBlob4844TxFromRLP()

> **createBlob4844TxFromRLP**(`serialized`, `opts`): [`Blob4844Tx`](../classes/Blob4844Tx.md)

Defined in: [4844/constructors.ts:278](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/tx/src/4844/constructors.ts#L278)
