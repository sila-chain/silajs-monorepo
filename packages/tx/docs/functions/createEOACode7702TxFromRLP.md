...
[@silajs/tx](../README.md) / createEOACode7702TxFromRLP

# Function: createEOACode7702TxFromRLP()

> **createEOACode7702TxFromRLP**(`serialized`, `opts`): [`EOACode7702Tx`](../classes/EOACode7702Tx.md)

Defined in: [7702/constructors.ts:90](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/tx/src/7702/constructors.ts#L90)
