...
[@silajs/tx](../README.md) / accessListBytesToJSON

# Function: accessListBytesToJSON()

> **accessListBytesToJSON**(`accessList`): [`AccessList`](../type-aliases/AccessList.md)

Defined in: [util/access.ts:11](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/tx/src/util/access.ts#L11)
