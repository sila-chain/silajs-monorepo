...
[@silajs/tx](../README.md) / createFeeMarket1559Tx

# Function: createFeeMarket1559Tx()

> **createFeeMarket1559Tx**(`txData`, `opts`): [`FeeMarket1559Tx`](../classes/FeeMarket1559Tx.md)

Defined in: [1559/constructors.ts:28](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/tx/src/1559/constructors.ts#L28)
