...
[@silajs/tx](../README.md) / normalizeTxParams

# Function: normalizeTxParams()

> **normalizeTxParams**(`txParamsFromRPC`): [`TypedTxData`](../type-aliases/TypedTxData.md)

Defined in: [util/general.ts:11](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/tx/src/util/general.ts#L11)
