...
[@silajs/tx](../README.md) / createTxFromBlockBodyData
...
Defined in: [transactionFactory.ts:94](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/tx/src/transactionFactory.ts#L94)
