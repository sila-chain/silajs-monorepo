...
[@silajs/tx](../README.md) / createLegacyTxFromRLP

# Function: createLegacyTxFromRLP()

> **createLegacyTxFromRLP**(`serialized`, `opts`): [`LegacyTx`](../classes/LegacyTx.md)

Defined in: [legacy/constructors.ts:61](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/tx/src/legacy/constructors.ts#L61)
