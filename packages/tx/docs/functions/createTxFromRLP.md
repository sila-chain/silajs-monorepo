...
[@silajs/tx](../README.md) / createTxFromRLP

# Function: createTxFromRLP()

> **createTxFromRLP**\<`T`\>(`data`, `txOptions`): [`Transaction`](../interfaces/Transaction.md)\[`T`\]

Defined in: [transactionFactory.ts:62](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/tx/src/transactionFactory.ts#L62)
