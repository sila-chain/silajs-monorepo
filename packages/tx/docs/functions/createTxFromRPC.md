...
[@silajs/tx](../README.md) / createTxFromRPC

# Function: createTxFromRPC()

> **createTxFromRPC**\<`T`\>(`txData`, `txOptions`): `Promise`\<[`Transaction`](../interfaces/Transaction.md)\[`T`\]\>

Defined in: [transactionFactory.ts:115](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/tx/src/transactionFactory.ts#L115)
