...
import { Address, hexToBytes, toBytes } from '@silajs/util'
...
import type { AddressLike, BigIntLike, BytesLike, PrefixedHexString } from '@silajs/util'
...
describe('[Transaction Input Values]', () => {
  ...
  it('SIP-1559 Transaction Values', () => {
    ...
    const sip1559TxData = generateCombinations({
      options,
    })
    const randomSample = getRandomSubarray(sip1559TxData, 100)
