/**
 * This example shows how to initialize an SIP-7702 (Set EOA account code) transaction
...
import type { EOACode7702AuthorizationListItemUnsigned } from '@silajs/util'
import {
  Address,
...
const unsignedAuthorizationListItemOther: EOACode7702AuthorizationListItemUnsigned = {
  chainId: '0x', // The chainId 0 is special: this authorization will work on any chain which supports SIP-7702
