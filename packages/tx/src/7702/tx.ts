...
import type { Address, EOACode7702AuthorizationListBytes } from '@silajs/util'
...
import * as SIP7702 from '../capabilities/sip7702.ts'
...
export class EOACode7702Tx implements TransactionInterface<typeof TransactionType.EOACodeEIP7702> {
  ...
  public constructor(txData: TxData, opts: TxOptions = {}) {
    ...
    if (!this.common.isActivatedEIP(7702)) {
      throw SilaJSErrorWithoutCode('SIP-7702 not enabled on Common')
    }
    ...
    SIP7702.verifyAuthorizationList(this)
   ...
   */
  getDataGas(): bigint {
    return SIP7702.getDataGas(this)
  }
  ...
  toCreationAddress(): never {
    throw SilaJSErrorWithoutCode('EOACode7702Tx cannot create contracts')
  }
  ...
  getMessageToSign(): Uint8Array {
    return SIP2718.serialize(this, this.raw().slice(0, 10))
  }
