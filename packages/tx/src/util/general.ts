import { TypeOutput, setLengthLeft, toBytes, toType } from '@silajs/util'
...
export const normalizeTxParams = (txParamsFromRPC: any): TypedTxData => {
  ...
  // For instance: https://optimistic.silascan.io/tx/0xf4304cb09b3f58a8e5d20fec5f393c96ccffe0269aaf632cb2be7a8a0f0c91cc
