...
This package contains common test data used across SilaJS packages. It is intended to be used as a devDependency in other packages within the monorepo.
...
```typescript
import { testData } from '@silajs/testdata'
```

## Development

This package is not published to npm and is meant to be used only within the SilaJS monorepo.
