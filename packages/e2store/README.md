...
| A collection of utility functions for Sila data storage formats. |
| ------------------------------------------------------------------- |

> **\[CONSIDERED FOR DEPRECATION\]** This library is being considered for deprecation. If you find it useful, please let us know!

`@silajs/e2store` provides utilities for working with Sila data storage formats, including E2HS, Era1, and Era files. These formats are commonly used for storing historical blockchain data, beacon states, and block data in an efficient, provable, and standardized way.

## Table of Contents

- [@silajs/e2store `v10`](#silajse2store-v10)
...
```ts
import { formatEntry } from "@silajs/e2store"
```
...
```ts
import { formatE2HS } from "@silajs/e2store"
...
Export history from an SilaJS client DB in epochs of 8192 blocks as Era1 files:

```ts
import { exportEpochAsEra1 } from "@silajs/e2store"

const dataDir = PATH_TO_SILAJS_CLIENT_DB
const epoch = 0
...
[e2store-npm-link]: https://www.npmjs.org/package/@silajs/e2store
...
[e2store-actions-badge]: https://github.com/sila-chain/silajs-monorepo/workflows/E2Store/badge.svg
[e2store-actions-link]: https://github.com/sila-chain/silajs-monorepo/actions?query=workflow%3A%22E2Store%22
[e2store-coverage-badge]: https://codecov.io/gh/sila-chain/silajs-monorepo/branch/master/graph/badge.svg?flag=e2store
[e2store-coverage-link]: https://codecov.io/gh/sila-chain/silajs-monorepo/tree/master/packages/e2store
