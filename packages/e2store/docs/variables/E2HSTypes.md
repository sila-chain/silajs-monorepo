...
[@silajs/e2store](../README.md) / E2HSTypes

# Variable: E2HSTypes

> `const` **E2HSTypes**: `object`

Defined in: [packages/e2store/src/types.ts:66](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/types.ts#L66)
