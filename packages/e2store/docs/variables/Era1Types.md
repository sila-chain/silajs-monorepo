...
[@silajs/e2store](../README.md) / Era1Types

# Variable: Era1Types

> `const` **Era1Types**: `object`

Defined in: [packages/e2store/src/types.ts:14](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/types.ts#L14)
