...
[@silajs/e2store](../README.md) / readBlockTupleAtOffset

# Function: readBlockTupleAtOffset()

> **readBlockTupleAtOffset**(`bytes`, `recordStart`, `offset`): `object`

Defined in: [packages/e2store/src/era1/blockTuple.ts:66](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/era1/blockTuple.ts#L66)
