...
[@silajs/e2store](../README.md) / readBeaconState
...
Defined in: [packages/e2store/src/era/era.ts:63](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/era/era.ts#L63)
