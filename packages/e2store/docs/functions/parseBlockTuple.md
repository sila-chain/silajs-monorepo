...
[@silajs/e2store](../README.md) / parseBlockTuple

# Function: parseBlockTuple()

> **parseBlockTuple**(`__namedParameters`): `Promise`\<\{ `body`: `any`; `header`: `any`; `receipts`: `any`; `totalDifficulty`: `any`; \}\>

Defined in: [packages/e2store/src/era1/blockTuple.ts:48](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/era1/blockTuple.ts#L48)
