...
[@silajs/e2store](../README.md) / readE2HSTupleAtOffset

# Function: readE2HSTupleAtOffset()

> **readE2HSTupleAtOffset**(`bytes`, `offset`): `object`

Defined in: [packages/e2store/src/e2hs/blockTuple.ts:24](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/e2hs/blockTuple.ts#L24)
