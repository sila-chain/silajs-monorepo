...
[@silajs/e2store](../README.md) / readE2HSTupleAtIndex
...
Defined in: [packages/e2store/src/e2hs/e2hs.ts:62](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/e2hs/e2hs.ts#L62)
