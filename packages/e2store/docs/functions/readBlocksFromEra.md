...
[@silajs/e2store](../README.md) / readBlocksFromEra
...
Defined in: [packages/e2store/src/era/era.ts:123](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/era/era.ts#L123)
