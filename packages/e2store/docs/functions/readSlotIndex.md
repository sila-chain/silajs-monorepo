...
[@silajs/e2store](../README.md) / readSlotIndex

# Function: readSlotIndex()

> **readSlotIndex**(`bytes`): [`SlotIndex`](../type-aliases/SlotIndex.md)

Defined in: [packages/e2store/src/era/era.ts:13](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/era/era.ts#L13)
