...
[@silajs/e2store](../README.md) / readBeaconBlock
...
Defined in: [packages/e2store/src/era/era.ts:91](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/era/era.ts#L91)
