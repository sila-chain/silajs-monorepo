...
[@silajs/e2store](../README.md) / getEraIndexes

# Function: getEraIndexes()

> **getEraIndexes**(`eraContents`): `object`

Defined in: [packages/e2store/src/era/era.ts:46](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/era/era.ts#L46)
