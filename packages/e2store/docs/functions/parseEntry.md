...
[@silajs/e2store](../README.md) / parseEntry
...
Defined in: [packages/e2store/src/e2store.ts:16](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/e2store.ts#L16)
