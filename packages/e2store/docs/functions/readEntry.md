...
[@silajs/e2store](../README.md) / readEntry

# Function: readEntry()

> **readEntry**(`bytes`): [`e2StoreEntry`](../type-aliases/e2StoreEntry.md)

Defined in: [packages/e2store/src/e2store.ts:50](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/e2store.ts#L50)
