...
[@silajs/e2store](../README.md) / readTuplesFromE2HS
...
Defined in: [packages/e2store/src/e2hs/e2hs.ts:50](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/e2store/src/e2hs/e2hs.ts#L50)
