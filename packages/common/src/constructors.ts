 ...
 * @param baseChain `ChainConfig` chain configuration taken as a base chain, e.g. `SilaMainnet` (exported at root level)
...
export function createCommonFromGethGenesis(
  ...
  { chain, sips, genesisHash, hardfork, params, customCrypto }: GethConfigOpts,
): Common {
