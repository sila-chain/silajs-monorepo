...
export const SilaMainnet: ChainConfig = {
  name: 'sila-mainnet',
  chainId: 1,
  ...
  hardforks: [
    ...
    },
    {
      ...
      // terminal block: https://silascan.io/block/15537393
      name: 'paris',
      block: 15537394,
      forkHash: '0xf0afd0e3',
    },
  ...
  dnsNetworks: [
    'enrtree://AKA3AM6LPBYEUDMVNU3BSVQJ5AD45Y7YPOHJLEF6W26QOE4VTUDPE@all.sila-mainnet.ethdisco.net',
  ],
}

export const SilaSepolia: ChainConfig = {
  name: 'sepolia',
  chainId: 11155111,
  defaultHardfork: 'prague',
  consensus: {
  ...
  url: 'https://github.com/sila-chain/go-sila/pull/23730',
  genesis: {
  ...
  hardforks: [
    ...
    {
      // The forkHash will remain same as mergeNetsplitBlock is post merge,
      // terminal block: https://sepolia.silascan.io/block/1450408
      name: 'paris',
      block: 1450409,
      forkHash: '0xfe3366e7',
    },
...
export const SilaHolesky: ChainConfig = {
  name: 'holesky',
  chainId: 17000,
  defaultHardfork: 'prague',
  consensus: {
  ...
  url: 'https://github.com/sil-clients/holesky/',
  genesis: {
...
export const Hoodi: ChainConfig = {
  ...
  comment: 'PoS test network to replace SilaHolesky',
  url: 'https://github.com/sil-clients/hoodi',
  genesis: {
    baseFeePerGas: '0x3B9ACA00',
    difficulty: '0x01',
    extraData: '0x',
