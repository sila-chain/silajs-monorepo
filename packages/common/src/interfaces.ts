/**
 * External Interfaces for other SilaJS libraries
 */
 ...
 * in the `@silajs/savm` package).
 *
 * `StatefulBinaryTreeStateManager` from `@silajs/statemanager` implements
 ...
 * class) so that this package does not depend on `@silajs/binarytree`;
...
/*
 * Generic StateManager interface corresponding with the @silajs/statemanager package
 *
 */
export interface StateManagerInterface {
  ...
  /*
   * SAVM/VM Specific Functionality
   */
