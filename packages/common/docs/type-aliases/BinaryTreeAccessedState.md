...
[@silajs/common](../README.md) / BinaryTreeAccessedState
...
Defined in: [common/src/interfaces.ts:89](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/common/src/interfaces.ts#L89)
