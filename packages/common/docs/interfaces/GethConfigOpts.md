...
[@silajs/common](../README.md) / GethConfigOpts

# Interface: GethConfigOpts

Defined in: [common/src/types.ts:152](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/common/src/types.ts#L152)
...
Defined in: [common/src/types.ts:153](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/common/src/types.ts#L153)
...
Defined in: [common/src/types.ts:154](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/common/src/types.ts#L154)
