...
[@silajs/common](../README.md) / BaseOpts

# Interface: BaseOpts

Defined in: [common/src/types.ts:94](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/common/src/types.ts#L94)
