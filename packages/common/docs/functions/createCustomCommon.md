...
[@silajs/common](../README.md) / createCustomCommon

# Function: createCustomCommon()

> **createCustomCommon**(`partialConfig`, `baseChain`, `opts`): [`Common`](../classes/Common.md)

Defined in: [common/src/constructors.ts:22](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/common/src/constructors.ts#L22)
...
`ChainConfig` chain configuration taken as a base chain, e.g. `SilaMainnet` (exported at root level)
