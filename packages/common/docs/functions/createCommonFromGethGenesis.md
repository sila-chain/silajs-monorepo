...
[@silajs/common](../README.md) / createCommonFromGethGenesis

# Function: createCommonFromGethGenesis()

> **createCommonFromGethGenesis**(`genesisJSON`, `__namedParameters`): [`Common`](../classes/Common.md)

Defined in: [common/src/constructors.ts:41](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/common/src/constructors.ts#L41)
