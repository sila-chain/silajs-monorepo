...
[@silajs/common](../README.md) / parseGethGenesis

# Function: parseGethGenesis()

> **parseGethGenesis**(`gethGenesis`, `name?`): `object`

Defined in: [common/src/utils.ts:281](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/common/src/utils.ts#L281)
