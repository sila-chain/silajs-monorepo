...
`@silajs/rlp` is the monorepo's canonical RLP encoder/decoder — a dependency of nearly every other package and often used directly when serializing trie nodes, block bodies, or devp2p payloads. Within the `10.1.2` round this package fixes a decoding edge case in `hexToBytes` and bumps in version with the rest of the monorepo. There are no SilaAmsterdam-specific API changes here; BAL and block RLP extensions are handled in `@silajs/util` and `@silajs/block`.

### At a glance

- Fix `hexToBytes` edge case in RLP decoding paths, see PR [#4276](https://github.com/sila-chain/silajs-monorepo/pull/4276).
- Monorepo version sync for `@silajs/*` `10.1.2`.

### SilaAmsterdam (experimental)

SilaAmsterdam fork work lives in [@silajs/vm](https://github.com/sila-chain/silajs-monorepo/tree/master/packages/vm#amsterdam-hardfork-experimental) and related packages. RLP continues to provide generic encode/decode primitives unchanged.
...
The `RLP.decode()` method has been optimized (thanks @wemeetagain for the contribution! ❤️) which results in a reproducible 10-30x speedup for JS native decoding 🎉, see PR [#3243](https://github.com/sila-chain/silajs-monorepo/pull/3243).
...
- Fixes the RLP CLI, PR [#3007](https://github.com/sila-chain/silajs-monorepo/pull/3007)
...
See [RC1 release notes](https://github.com/sila-chain/silajs-monorepo/releases/tag/%40silajs%2Frlp%405.0.0-rc.1) for the main change description.
...
The `@silajs/rlp` library is the only SilaJS library where the Buffer -> Uint8Array transition has already taken place in the major release version before, so `v4.0.0`.
...
We now have also added helper methods for "Buffer -> Uint8Array" conversions in the [@silajs/util](https://github.com/sila-chain/silajs-monorepo/tree/master/packages/util) `bytes` module, see the respective README section for guidance.

## 4.0.1 - 2023-02-21

- Avoid copy in `RLP.encode()`, PR [#2476](https://github.com/sila-chain/silajs-monorepo/pull/2476)

## 4.0.0 - 2022-09-06

Final release - tada 🎉 - of a wider breaking release round on the [SilaJS monorepo](https://github.com/sila-chain/silajs-monorepo) libraries, see the Beta 1 release notes for the main long change set description as well as the Beta 2, Beta 3 and Release Candidate (RC) 1 release notes for notes on some additional changes ([CHANGELOG](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/rlp/CHANGELOG.md)).
...
**Attention!** This library has been renamed along this release and moved to the scoped package name format already used for most of the other SilaJS libraries, see PR [#2092](https://github.com/sila-chain/silajs-monorepo/pull/2092). In this case the library is renamed as follows:
...
Beta 2 release for the upcoming breaking release round on the [SilaJS monorepo](https://github.com/sila-chain/silajs-monorepo) libraries, see the Beta 1 release notes ([CHANGELOG](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/rlp/CHANGELOG.md)) for the main change set description.
...
The v3 release replaces Buffers as input and output values in favor of Uint8Arrays for improved performance and greater compatibility with browsers, see `v3.0.0` [release notes](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/rlp/CHANGELOG.md#300---2022-01-27).

There are new conversion functions added to the `@silajs/util` library, see [RLP docs](https://github.com/sila-chain/silajs-monorepo/tree/master/packages/rlp#buffer-compatibility) on how to use and do the conversion.

## 3.0.0 - 2022-01-27

rlp v3 is a breaking release with several important updates. Special thanks to [@paulmillr](https://github.com/paulmillr) for the majority of this work in PR [#90](https://github.com/sila-chain/silajs/rlp/pull/90).
...
When upgrading from rlp v2 to v3, you must convert your Buffers to Uint8Arrays before passing in. To help, two new utility methods were added to `silajs-util v7.1.4`: `arrToBufArr` and `bufArrToArr`. These will recursively step through your arrays to replace Buffers with Uint8Arrays, or vise versa.

Example:

```ts
// Old, rlp v2
import * as rlp from '@silajs/rlp'
...
Increased strictness has been added to ensure invalid RLPs are not decoded, see PR [#101](https://github.com/sila-chain/silajs/rlp/pull/101).

---

PRs included in this release:

- Fix karma, readme updates, combine source to one file, PR [#109](https://github.com/sila-chain/silajs/rlp/pull/109)
- Add browser support, remove dependencies, PR [#90](https://github.com/sila-chain/silajs/rlp/pull/90)
- Readme and typedoc updates, normalize source error messages to capital RLP, PR [#108](https://github.com/sila-chain/silajs/rlp/pull/108)
- Improve cli interface, PR [#95](https://github.com/sila-chain/silajs/rlp/pull/95)
- Ensure we do not decode invalid RLPs, PR [#101](https://github.com/sila-chain/silajs/rlp/pull/101)

[v3.0.0]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@2.2.7...rlp@3.0.0

## [v2.2.7] - 2021-10-06

- Performance: Avoid creating new array when checking first two chars, PR [#100](https://github.com/sila-chain/silajs/rlp/pull/100)
- Update BN from require to import, PR [#99](https://github.com/sila-chain/silajs/rlp/pull/99)
- Update dependencies to latest and add browser build, PR [#102](https://github.com/sila-chain/silajs/rlp/pull/102)

#### Included Source Files

Source files from the `src` folder are now included in the distribution build, see PR [#97](https://github.com/sila-chain/silajs/rlp/pull/97). This allows for a better debugging experience in debug tools like Chrome DevTools by having working source map references to the original sources available for inspection.

[v2.2.7]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@2.2.6...rlp@2.2.7

## [v2.2.6] - 2020-07-17

- Fixed a few edge-cases in decoding long strings that previously could cause
  OOM (Out of Memory) crash,
  PR [#91](https://github.com/sila-chain/silajs/rlp/pull/91)
- Updated GitHub `actions/checkout` to v2,
  PR [#92](https://github.com/sila-chain/silajs/rlp/pull/92)

[v2.2.6]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@2.2.5...rlp@2.2.6

## [v2.2.5] - 2020-05-25

- Added `BigInt` as an accepted encoding type,
  PR [#85](https://github.com/sila-chain/silajs/rlp/pull/85)
- Added support/testing for Node 10, 12, 13, 14, moved from Travis to GitHub Actions,
  PR [#87](https://github.com/sila-chain/silajs/rlp/pull/87)
- Formatting and config cleanups,
  PRs [#86](https://github.com/sila-chain/silajs/rlp/pull/86) and
  [#88](https://github.com/sila-chain/silajs/rlp/pull/88)

[v2.2.5]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@2.2.4...rlp@2.2.5

## [v2.2.4] - 2019-11-02

- Removed unused `Dictionary` `Input` type for `RLP.encode()` and `RLP.decode()`,
  PR [#74](https://github.com/sila-chain/silajs/rlp/pull/74)
- Removed unused `safe-buffer` dependency,
  PR [#80](https://github.com/sila-chain/silajs/rlp/pull/80)

[v2.2.4]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@2.2.3...rlp@2.2.4

## [v2.2.3] - 2019-03-19

- More robust `Array` type checking in `RLP.encode()` function,
  PR [#70](https://github.com/sila-chain/silajs/rlp/pull/70)
- Library now throws an error when trying to encode negative integer
  values (e.g. `RLP.encode(-1)`),
  PR [#71](https://github.com/sila-chain/silajs/rlp/pull/70)

[v2.2.3]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@2.2.2...rlp@2.2.3

## [v2.2.2] - 2019-01-15

- Added `bn.js` dependency to fix module resolution bug when require the module after
  clean install, PR [#64](https://github.com/sila-chain/silajs/rlp/pull/64)
- Use local version of official tests, fixed testing issue, PR [#66](https://github.com/sila-chain/silajs/rlp/pull/66)

[v2.2.2]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@2.2.1...rlp@2.2.2

## [v2.2.1] - 2018-12-20

- Fixed a bug introduced in `v2.2.0` causing the CLI `bin/rlp` command not to
  work, see PR [#60](https://github.com/sila-chain/silajs/rlp/pull/60)
- Additional exports of types used by `decode` and `encode`
  (PR [#59](https://github.com/sila-chain/silajs/rlp/pull/59)):
...
- Additional test structure and new integration tests for distribution and
  `bin/rlp` CLI command, see PR [#57](https://github.com/sila-chain/silajs/rlp/pull/57)

[v2.2.1]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@2.2.0...rlp@2.2.1
...
First `TypeScript` based release of `SilaJS` libraries, thanks @krzkaczor,
...
for `SilaJS` libraries. If you are developing in `TypeScript` you can
further already benefit from the `RLP` type declarations published from now on
along new releases.

See PR [#37](https://github.com/sila-chain/silajs/rlp/pull/37) and subsequent PRs merged
...
[silajs-config](https://github.com/sila-chain/silajs/silajs-config) centralizing
configuration for `SilaJS` libraries on `TypeScript` itself as well as
linting, formatting and testing.

This release passes all existing unit tests and other checks. If you nevertheless
experience problems please report on the `SilaJS`
[Gitter](https://gitter.im/sila/silajs) channel.

Other changes:

- Added `LICENSE` file for `MPL2.0`, see PR [#31](https://github.com/sila-chain/silajs/rlp/pull/31)

[v2.2.0]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@2.1.0...rlp@2.2.0

## [v2.1.0] - 2018-06-28

- Updated supported Node versions, PR [#13](https://github.com/sila-chain/silajs/rlp/pull/13)
- Switched to `safe-buffer` for backwards compatibility, PR [#18](https://github.com/sila-chain/silajs/rlp/pull/18)
- Increased test coverage, PR [#22](https://github.com/sila-chain/silajs/rlp/pull/22)
- Example code tweaks, PR [#12](https://github.com/sila-chain/silajs/rlp/pull/12)
- Fix test runs on Windows, Issue [#7](https://github.com/sila-chain/silajs/rlp/issues/7)
- Added code coverage, PR [#8](https://github.com/sila-chain/silajs/rlp/pull/8)

[v2.1.0]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@2.0.0...rlp@2.1.0

## [2.0.0] - 2015-09-23

- User `Buffer` values as input for encoding

[2.0.0]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@1.1.2...rlp@2.0.0

## [1.1.2] - 2015-09-22

- Fix zero encoding

[1.1.2]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@1.1.1...rlp@1.1.2

## [1.1.1] - 2015-09-21

- Fixes for `bin`

[1.1.1]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@1.1.0...rlp@1.1.1
...
[1.1.0]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@1.0.1...rlp@1.1.0

## [1.0.1] - 2015-06-27

- Code formatting clean-ups

[1.0.1]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@1.0.0...rlp@1.0.1
...
[1.0.0]: https://github.com/sila-chain/silajs-monorepo/compare/rlp@0.0.14...rlp@1.0.0

## Older releases:

- [0.0.14](https://github.com/sila-chain/silajs-monorepo/compare/rlp@0.0.13...rlp@0.0.14) - 2015-03-31
- [0.0.13](https://github.com/sila-chain/silajs-monorepo/compare/rlp@0.0.12...rlp@0.0.13) - 2015-03-30
- [0.0.12](https://github.com/sila-chain/silajs-monorepo/compare/rlp@0.0.11...rlp@0.0.12) - 2014-12-26
