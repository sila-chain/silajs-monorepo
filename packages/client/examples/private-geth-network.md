...
First, create a signer account and place in the `data` directory to use with geth to seal blocks following [these instructions](https://geth.sila.org/docs/interface/managing-your-accounts).
...
Start the silajs client with the custom genesis parameters:
