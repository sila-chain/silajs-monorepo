...
## Local Connections : SilaJS <- SilaJS
...
## Local Connection: SilaJS <- Geth

To connect Geth to a running SilaJS instance start a client with:
...
Then connect with your SilaJS instance via:
