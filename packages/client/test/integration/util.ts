...
import { type Common, ConsensusAlgorithm } from '@silajs/common'
...
): Promise<[MockServer, FullSilaService]> {
...
export async function destroy(server: MockServer, service: FullSilaService): Promise<void> {
