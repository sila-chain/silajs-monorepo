...
import { bigIntToHex, createAddressFromString } from '@silajs/util'
...
// Note: this is all added to ensure to run on Istanbul hardfork, and without a sila-mainnet genesis state setup
...
const common = createCustomCommon({ ...testnetData }, SilaMainnet)
...
describe(method, async () => {
  it('call with valid arguments', async () => {
    ...
    // contract inspired from https://sila.org/en/developers/docs/apis/json-rpc/#eth_getstorageat/
    /*
