import { SIGNER_H, beaconData, pragueGethGenesis } from '@silajs/testdata'
import { createTx } from '@silajs/tx'
import { Units, bigIntToHex, hexToBytes } from '@silajs/util'
...
describe(`${method}: call with executionPayloadV4`, () => {
  it('valid data', async () => {
    ...
    const expectedErrors = [
      ...
      'NewPayloadV4 MUST be used after SilaPrague is activated',
    ]
