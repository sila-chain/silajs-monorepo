import { createBlockchainFromBlocksData } from '@silajs/blockchain'
import { sila-mainnetBlocks } from '@silajs/testdata'
...
describe(method, async () => {
  it('call with valid arguments', async () => {
    ...
    assert.strictEqual(newHead.header.number, BigInt(sila-mainnetBlocks.length), 'should run all blocks')
