...
import { createBlob4844Tx, createLegacyTx } from '@silajs/tx'
import { bytesToHex, createZeroAddress, hexToBytes } from '@silajs/util'
...
const common = createCustomCommon({ chainId: 1 }, SilaMainnet, { customCrypto: { kzg } })
