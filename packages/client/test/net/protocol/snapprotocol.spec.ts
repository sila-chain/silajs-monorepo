import { decodeMPTNode, verifyMerkleRangeProof } from '@silajs/mpt'
...
// captured from a client that was fully synced up to block number 2023946 on the SilaSepolia network
