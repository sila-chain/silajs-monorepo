...
import { mergeTestnetChainConfig, postMergeGethGenesis } from '@silajs/testdata'
import { equalsBytes, utf8ToBytes } from '@silajs/util'
...
describe('[Skeleton] / setHead', async () => {
  ...
  it('should abort filling the canonical chain if the terminal block is invalid', async () => {
    const common = createCustomCommon(mergeTestnetChainConfig, SilaMainnet)
