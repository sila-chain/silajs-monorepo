import { BlockHeader, createBlock, createBlockHeader } from '@silajs/block'
import {
  Common,
  type GethGenesis,
  Hardfork,
...
import { SIGNER_A, SIGNER_B, goerliChainConfig } from '@silajs/testdata'
import { createFeeMarket1559Tx, createLegacyTx } from '@silajs/tx'
import type { Address } from '@silajs/util'
import { equalsBytes } from '@silajs/util'
...
const txA011 = createTx(
  // SIGNER_A -> SIGNER_B, nonce: 0, value: 1, normal gasPrice, sila-mainnet as chain
  SIGNER_A,
  SIGNER_B,
  0,
  1,
