...
export function createRPCServer(
  ...
  switch (methodConfig) {
    ...
    case MethodConfig.EngineOnly: {
      /**
       * Filter sil methods which should be strictly exposed if only the engine is started:
       * https://github.com/sila-chain/execution-apis/blob/6d2c035e4caafef7224cbb5fac7993b820bb61ce/src/engine/common.md#underlying-protocol
       * (Feb 3 2023)
       */
