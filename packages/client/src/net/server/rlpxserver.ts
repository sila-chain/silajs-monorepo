import { DPT as Devp2pDPT, RLPx as Devp2pRLPx } from '@silajs/devp2p'
import { bytesToUnprefixedHex, unprefixedHexToBytes, utf8ToBytes } from '@silajs/util'
...
import type { Peer as Devp2pRLPxPeer } from '@silajs/devp2p'
  ...
  private async initDpt() {
    return new Promise<void>((resolve) => {
      this.dpt = new Devp2pDPT(this.key, {
        ...
        onlyConfirmed: this.config.chainCommon.chainName() === 'sila-mainnet' ? false : true,
