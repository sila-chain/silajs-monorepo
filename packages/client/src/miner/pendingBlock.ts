...
import { BuildStatus, buildBlock } from '@silajs/vm'
import { keccak_256 } from '@noble/hashes/sha3.js'

import type { Block, HeaderData } from '@silajs/block'
import type { TypedTransaction } from '@silajs/tx'
import type { CLRequest, CLRequestType, PrefixedHexString, WithdrawalData } from '@silajs/util'
import type { BlockBuilder, TxReceipt, VM } from '@silajs/vm'
...
export class PendingBlock {
  ...
  /**
   * An internal helper for storing the blob bundle associated with each transaction in an SIP4844 world
