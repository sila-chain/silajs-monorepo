...
import type { Hardfork } from '@silajs/common'
 ...
 */
export const errSyncReorged = SilaJSErrorWithoutCode('sync reorged')
 ...
 */
export const errReorgDenied = SilaJSErrorWithoutCode('non-forced head reorg denied')
 ...
 * should abort and restart with the new state.
 */
export const errSyncMerged = SilaJSErrorWithoutCode('sync merged')
