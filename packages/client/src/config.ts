...
import { genPrivateKey } from '@silajs/devp2p'
import { type Address, BIGINT_0, BIGINT_1, BIGINT_2, BIGINT_256 } from '@silajs/util'
...
import type { VM, VMProfilerOpts } from '@silajs/vm'
...
export class Config {
  ...
  public static readonly CHAIN_DEFAULT = SilaMainnet
