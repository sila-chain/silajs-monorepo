...
function uint(uint: number, params: any[], index: number) {
  if (uint % 8 !== 0) {
    // Sanity check
    throw SilaJSErrorWithoutCode(`Uint should be a multiple of 8, got: ${uint}`)
  }
  if (typeof params[index] !== 'string') {
    return {
      code: INVALID_PARAMS,
...
export const validators = {
  ...
  get blob() {
    ...
    // See: https://github.com/sila-chain/execution-apis/blob/b7c5d3420e00648f456744d121ffbd929862924d/src/engine/experimental/blob-extension.md
