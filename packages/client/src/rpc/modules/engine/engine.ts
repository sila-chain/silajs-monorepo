...
import type { Block, ExecutionPayload } from '@silajs/block'
...
import type { FullSilaService, Skeleton } from '../../../service/index.ts'
 ...
 */
export class Engine {
  private client: SilaClient
  private execution: VMExecution
  private skeleton: Skeleton
  private service: FullSilaService
  private chain: Chain
  ...
  constructor(client: SilaClient, rpcDebug: boolean) {
    this.client = client
    this.service = client.service as FullSilaService
   ...
   * rule set (SIP-3675) and returns the status of the verification.
   *
    ...
    try {
      ...
      if (errorMsg.includes('block') && errorMsg.includes('not found')) {
        if (blocks.length > 1) {
          ...
          // opcode.
          //
          // i)  error coding of the savm errors should be a better way to handle this OR
          // ii) figure out a way to pass let the savm access the above blocks which is what connects this
  ...
  /**
   * V1 (SilaParis HF), see:
   * https://github.com/sila-chain/execution-apis/blob/main/src/engine/paris.md#engine_newpayloadv1
   * @param params V1 payload
   * @returns
   */
  async newPayloadV1(params: [ExecutionPayloadV1]): Promise<PayloadStatusV1> {
    const shanghaiTimestamp = this.chain.config.chainCommon.hardforkTimestamp(Hardfork.SilaShanghai)
    const ts = parseInt(params[0].timestamp)
    if (shanghaiTimestamp !== null && ts >= shanghaiTimestamp) {
      throw {
        code: INVALID_PARAMS,
        message: 'NewPayloadV2 MUST be used after SilaShanghai is activated',
      }
    }
  ...
  /**
   * V2 (SilaShanghai HF) including withdrawals, see:
  ...
  async newPayloadV2(params: [ExecutionPayloadV2 | ExecutionPayloadV1]): Promise<PayloadStatusV1> {
    const shanghaiTimestamp = this.chain.config.chainCommon.hardforkTimestamp(Hardfork.SilaShanghai)
    const sip4844Timestamp = this.chain.config.chainCommon.hardforkTimestamp(Hardfork.SilaCancun)
    const ts = parseInt(params[0].timestamp)

    const withdrawals = (params[0] as ExecutionPayloadV2).withdrawals

    if (sip4844Timestamp !== null && ts >= sip4844Timestamp) {
      throw {
        code: INVALID_PARAMS,
        message: 'NewPayloadV3 MUST be used after SilaCancun is activated',
      }
    } else if (shanghaiTimestamp === null || parseInt(params[0].timestamp) < shanghaiTimestamp) {
      if (withdrawals !== undefined && withdrawals !== null) {
        throw {
          code: INVALID_PARAMS,
          message: 'ExecutionPayloadV1 MUST be used before SilaShanghai is activated',
        }
      }
      ...
      if (withdrawals === undefined || withdrawals === null) {
        throw {
          code: INVALID_PARAMS,
          message: 'ExecutionPayloadV2 MUST be used after SilaShanghai is activated',
        }
      }
  ...
  /**
   * V3 (SilaCancun HF) including blob versioned hashes + parent beacon block root, see:
   * https://github.com/sila-chain/execution-apis/blob/main/src/engine/cancun.md#engine_newpayloadv3
  ...
  async newPayloadV3(params: [ExecutionPayloadV3, Bytes32[], Bytes32]): Promise<PayloadStatusV1> {
    const sip4844Timestamp = this.chain.config.chainCommon.hardforkTimestamp(Hardfork.SilaCancun)
    const pragueTimestamp = this.chain.config.chainCommon.hardforkTimestamp(Hardfork.SilaPrague)

    const ts = parseInt(params[0].timestamp)
    if (pragueTimestamp !== null && ts >= pragueTimestamp) {
      throw {
        code: INVALID_PARAMS,
        message: 'NewPayloadV4 MUST be used after SilaPrague is activated',
      }
    } else if (sip4844Timestamp === null || ts < sip4844Timestamp) {
      throw {
        code: UNSUPPORTED_FORK,
        message: 'NewPayloadV{1|2} MUST be used before SilaCancun is activated',
      }
    }
  ...
  async newPayloadV4(
    ...
    if (pragueTimestamp === null || ts < pragueTimestamp) {
      throw {
        code: UNSUPPORTED_FORK,
        message: 'NewPayloadV{1|2|3} MUST be used before SilaPrague is activated',
      }
    }
  ...
  /**
   * V1 (SilaParis HF), see:
   * https://github.com/sila-chain/execution-apis/blob/main/src/engine/paris.md#engine_forkchoiceupdatedv1
  ...
  /**
   * V2 (SilaShanghai HF), see:
   * https://github.com/sila-chain/execution-apis/blob/main/src/engine/shanghai.md#engine_forkchoiceupdatedv2
    ...
    if (payloadAttributes !== undefined && payloadAttributes !== null) {
      ...
      if (withdrawals !== undefined && withdrawals !== null) {
        if (ts < shanghaiTimestamp!) {
          throw {
            code: INVALID_PARAMS,
            message: 'PayloadAttributesV1 MUST be used before SilaShanghai is activated',
          }
        }
      } else {
        if (ts >= shanghaiTimestamp!) {
          throw {
            code: INVALID_PARAMS,
            message: 'PayloadAttributesV2 MUST be used after SilaShanghai is activated',
          }
        }
      }
  ...
  /**
   * V3 (SilaCancun HF), see:
   * https://github.com/sila-chain/execution-apis/blob/main/src/engine/cancun.md#engine_forkchoiceupdatedv3
  ...
  private async getPayload(params: [Bytes8], payloadVersion: number) {
    ...
    try {
      ...
      switch (payloadVersion) {
        case 5:
          checkNotBeforeHf = Hardfork.SilaOsaka
          checkNotAfterHf = Hardfork.SilaOsaka
          break

        case 4:
          checkNotBeforeHf = Hardfork.SilaPrague
          checkNotAfterHf = Hardfork.SilaPrague
          break

        case 3:
          checkNotBeforeHf = Hardfork.SilaCancun
          checkNotAfterHf = Hardfork.SilaCancun
          break

        case 2:
          // no checks to be done for before as valid till paris
          checkNotBeforeHf = null
          checkNotAfterHf = Hardfork.SilaShanghai
          break

        case 1:
          checkNotBeforeHf = null
          checkNotAfterHf = Hardfork.SilaParis
          break
  ...
  /**
   * V1 (SilaParis HF), see:
   * https://github.com/sila-chain/execution-apis/blob/main/src/engine/paris.md#engine_getpayloadv1
  ...
  /**
   * V2 (SilaShanghai HF), see:
   * https://github.com/sila-chain/execution-apis/blob/main/src/engine/shanghai.md#engine_getpayloadv2
   * @param params Identifier of the payload build process
   * @returns
   */
  ...
  /**
   * V3 (SilaCancun HF), see:
   * https://github.com/sila-chain/execution-apis/blob/main/src/engine/cancun.md#engine_getpayloadv3
   * @param params Identifier of the payload build process
   * @returns
   */
   ...
   *
   * See:
   * https://github.com/sila-chain/execution-apis/blob/main/src/engine/common.md#engine_exchangecapabilities
   */
  ...
  /**
   * V1 (SilaShanghai HF), see:
   * https://github.com/sila-chain/execution-apis/blob/main/src/engine/shanghai.md#engine_getpayloadbodiesbyhashv1
   *
  ...
  /**
   * V1 (SilaShanghai HF), see:
   * https://github.com/sila-chain/execution-apis/blob/main/src/engine/shanghai.md#engine_getpayloadbodiesbyrangev1
   *
