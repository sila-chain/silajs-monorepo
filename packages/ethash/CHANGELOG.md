...
- Performance: Cache often used BigInt constants, PR [#3050](https://github.com/sila-chain/silajs-monorepo/pull/3050)
...
See [RC1 release notes](https://github.com/sila-chain/silajs-monorepo/releases/tag/%40silajs%2Fethash%403.0.0-rc.1) for the main change description.
...
- Breaking: Changes in the database layer usage, PR [#2669](https://github.com/sila-chain/silajs-monorepo/pull/2669)
...
- Updated `@silajs/block` dependency version to `v4.0.1`
...
- Internal refactor: removed ambiguous boolean checks within conditional clauses, PR [#2253](https://github.com/sila-chain/silajs-monorepo/pull/2253)

## 2.0.0-rc.1 - 2022-08-29

Release candidate 1 for the upcoming breaking release round on the [SilaJS monorepo](https://github.com/sila-chain/silajs-monorepo) libraries, see the Beta 1 release notes for the main long change set description as well as the Beta 2 and 3 release notes for notes on some additional changes ([CHANGELOG](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/ethash/CHANGELOG.md)).
...
Beta 2 release for the upcoming breaking release round on the [SilaJS monorepo](https://github.com/sila-chain/silajs-monorepo) libraries, see the Beta 1 release notes ([CHANGELOG](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/ethash/CHANGELOG.md)) for the main change set description.
...
```ts
import Ethash from '@silajs/ethash'
```
...
The `Ethash` library has been promisified and callbacks have been removed along PR [#833](https://github.com/sila-chain/silajs-monorepo/pull/833) and preceding PR [#779](https://github.com/sila-chain/silajs-monorepo/pull/779).
...
See `Ethash` [README](https://github.com/sila-chain/silajs-monorepo/tree/master/packages/ethash#usage) for a complete example.

[1.0.0]: https://github.com/sila-chain/silajs-monorepo/releases/tag/%40silajs%2Fethash%401.0.0
...
- Updated Block dependency to `@silajs/block` `v3.0.0`, PR [#883](https://github.com/sila-chain/silajs-monorepo/pull/883)
- Removed `async` dependency, PR [#779](https://github.com/sila-chain/silajs-monorepo/pull/779)

## 1.0.0-rc.1 - 2020-11-19

This is the first release candidate towards a final library release, see [beta.1](https://github.com/sila-chain/silajs-monorepo/releases/tag/%40silajs%2Fethash%401.0.0-beta.1) release notes for an overview on the full changes since the last publicly released version.
...
**Attention!** This new version is part of a series of SilaJS releases all moving to a
...
See `Ethash` [README](https://github.com/sila-chain/silajs-monorepo/tree/master/packages/ethash#usage)
...
- Updated Block dependency to `@silajs/block` `v3.0.0`,
...
Changes from PR [#23](https://github.com/sila-chain/silajs/ethashjs/pull/23):

- Upgraded CI from travis to GH Actions
- Node versions tested updated from [4, 5] to [10, 12, 13, 14]
- Upgraded dev deps (silajs-block, nyc, standard)
- Added `ethash_tests.json` to test dir and removes silajs-testing dep
- Use single imports for silajs-util, upgrades to v7.0.2
- Modernizes buffer init syntax

Further/preceding dependency updates in
PR [#19](https://github.com/sila-chain/silajs/ethashjs/pull/19),
PR [#11](https://github.com/sila-chain/silajs/ethashjs/pull/11),
PR [#8](https://github.com/sila-chain/silajs/ethashjs/pull/8) and
PR [#7](https://github.com/sila-chain/silajs/ethashjs/pull/7)

[0.0.8]: https://github.com/sila-chain/silajs/ethashjs/compare/v0.0.7...v0.0.8

## Older releases:

- [0.0.7](https://github.com/sila-chain/silajs/ethashjs/compare/v0.0.6...v0.0.7) - 2016-05-01
- [0.0.6](https://github.com/sila-chain/silajs/ethashjs/compare/v0.0.5...v0.0.6) - 2016-01-08
- [0.0.5](https://github.com/sila-chain/silajs/ethashjs/compare/v0.0.4...v0.0.5) - 2015-11-27
- 0.0.4 - 2015-10-01
