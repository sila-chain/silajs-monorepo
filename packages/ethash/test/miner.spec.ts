...
describe('Miner', () => {
  ...
  it('Should keep common when mining blocks or headers', async () => {
    ...
    assert.strictEqual(solution.common.chainName(), 'sila-mainnet', 'chain name did not change')
    ...
    assert.strictEqual(blockSolution.common.chainName(), 'sila-mainnet', 'chain name did not change')
  }, 60000)
})
