...
describe('message sig', () => {
  ...
  it('should support compact signature representation (SIP-2098)', () => {
    const sig =
  ...
  it('should support compact signature representation (SIP-2098) (v=0)', () => {
    const sig =
      '0x99e71a99cb2270b8cac5254f9e99b6210c6c10224a1579cf389ef88b20a1abe9129ff05af364204442bdb53ab6f18a99ab48acc9326fa689f228040429e3ca66'
  ...
  it('should support compact signature representation 2 (SIP-2098)', () => {
    const sig =
  ...
  it('should support compact signature representation 2 (SIP-2098) (v=1)', () => {
    const sig =
      '0x99e71a99cb2270b8cac5254f9e99b6210c6c10224a1579cf389ef88b20a1abe9929ff05af364204442bdb53ab6f18a99ab48acc9326fa689f228040429e3ca66'
