...
describe('Units', () => {
  describe('sila()', () => {
    it('should convert 1 sila to wei', () => {
      const result = Units.sila(1)
      assert.strictEqual(result, BigInt(10 ** 18))
    })

    it('should convert 0 sila to wei', () => {
      const result = Units.sila(0)
      assert.strictEqual(result, BigInt(0))
    })

    it('should convert a large number of sila to wei', () => {
      const result = Units.sila(1000000)
    ...
    it('should convert a bigint amount of sila to wei', () => {
      const result = Units.sila(BigInt(2))
