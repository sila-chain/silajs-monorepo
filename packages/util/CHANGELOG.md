...
- Fix `Account.isEmpty()` when called on partial accounts (e.g. state trie reads), see PR [#4268](https://github.com/sila-chain/silajs-monorepo/pull/4268).
- Add `isDebugEnabled(namespace)` — avoids `ReferenceError` in workers where `process` is undeclared, see PR [#4265](https://github.com/sila-chain/silajs-monorepo/pull/4265).
...
Key exports include `createBlockLevelAccessListFromJSON` / `FromRLP`, `validateBlockAccessListStructure`, `validateBlockAccessListGasLimit`, `hashBlockAccessListFromJSON`, and `equalsBlockAccessList`. See the [Module: bal](https://github.com/sila-chain/silajs-monorepo/tree/master/packages/util#module-bal) section in the README for the full at-a-glance map.

### Changes

- SIP-7928 BAL types, `BlockLevelAccessList`, canonical RLP/JSON encoding, and validation utilities, see PR [#4233](https://github.com/sila-chain/silajs-monorepo/pull/4233), [#4246](https://github.com/sila-chain/silajs-monorepo/pull/4246), [#4303](https://github.com/sila-chain/silajs-monorepo/pull/4303), [#4306](https://github.com/sila-chain/silajs-monorepo/pull/4306)
- README entry section with highlights, at-a-glance table, and grouped module guide, see PR [#4308](https://github.com/sila-chain/silajs-monorepo/pull/4308)

## 10.1.1 - 2025-01-28

- BigInt bytes conversion fixes, see PR [#4203](https://github.com/sila-chain/silajs-monorepo/pull/4203)
...
- Update `kzg-wasm` dependency, PR [#4169](https://github.com/sila-chain/silajs-monorepo/pull/4169)
- Integrate new `kzg-wasm` library version / Sanity & API Checks, PR [#4153](https://github.com/sila-chain/silajs-monorepo/pull/4153)
- Explicitly cast result type to Uint8Array<ArrayBuffer> to satisfy ESLint, PR [#4108](https://github.com/sila-chain/silajs-monorepo/pull/4108)
...
- Additional `authorization` module with `SIP-7702` authorization list signing utilities, PRs [#3933](https://github.com/sila-chain/silajs-monorepo/pull/3933) and [#4032](https://github.com/sila-chain/silajs-monorepo/pull/4032)
- `signature` module: Remove `ecsign` method (use `sila-cryptography` directly), PR [#3948](https://github.com/sila-chain/silajs-monorepo/pull/3948)
- `bytes` module: Stricter `hexToBytes()` method, PR [#3995](https://github.com/sila-chain/silajs-monorepo/pull/3995)
- `bytes` module: `bytesToHex()`now throws on `undefined` input (instead of returning `0x`), PR [#4004](https://github.com/sila-chain/silajs-monorepo/pull/4004)
...
Note: the `@silajs/util` package happens to already be on the v10 line, so no update here! 🙂
...
See PR [#3524](https://github.com/sila-chain/silajs-monorepo/pull/3524):
...
See PR [#3544](https://github.com/sila-chain/silajs-monorepo/pull/3544):
...
See PR [#3589](https://github.com/sila-chain/silajs-monorepo/pull/3589)
...
- `bytes`: Restrict `hexToBytes()`, `unpadHex()` and `hexToBigInt()` to accept only hex-prefixed values, PR [#3510](https://github.com/sila-chain/silajs-monorepo/pull/3510)
- Remove deprecated `initKZG()` method, PR [#3635](https://github.com/sila-chain/silajs-monorepo/pull/3635)
- Renaming all camel-case `Rpc`-> `RPC` and `Json` -> `JSON` names, PR [#3638](https://github.com/sila-chain/silajs-monorepo/pull/3638)
- Remove redundant fills and `zeros()` function, PR [#3709](https://github.com/sila-chain/silajs-monorepo/pull/3709)
...
- Use `noble` bytes conversion utilities internally, PR [#3698](https://github.com/sila-chain/silajs-monorepo/pull/3698)
- Added two simple unit conversion methods, `Units.sila()` and `Units.gwei()`, mainly to ease tx creation a bit, PRs [#3734](https://github.com/sila-chain/silajs-monorepo/pull/3734), [#3736](https://github.com/sila-chain/silajs-monorepo/pull/3736) and [#3738](https://github.com/sila-chain/silajs-monorepo/pull/3738)

## 9.1.0 - 2024-08-15

### Support for Partial Accounts

For Verkle or other contexts it can be useful to create partial accounts not containing all the account parameters. This is now supported starting with this release, see PR [#3269](https://github.com/sila-chain/silajs-monorepo/pull/3269):
...
This release introduces a new `requests` module (see PRs [#3372](https://github.com/sila-chain/silajs-monorepo/pull/3372), [#3393](https://github.com/sila-chain/silajs-monorepo/pull/3393), [#3398](https://github.com/sila-chain/silajs-monorepo/pull/3398) and [#3477](https://github.com/sila-chain/silajs-monorepo/pull/3477)) with various type and an abstract base class for [SIP-7685](https://sips.sila.org/SIPS/sip-7685) general purpose execution layer requests to the CL (SilaPrague hardfork) as well as concrete implementations for the currently supported request types:
...
- New `verkle` module with utility methods and interfaces, PR [#3462](https://github.com/sila-chain/silajs-monorepo/pull/3462)
- Rename verkle utils and refactor, PR [#3468](https://github.com/sila-chain/silajs-monorepo/pull/3468)
...
- Adjust `Account.isContract()` (in Verkle context work), PR [#3343](https://github.com/sila-chain/silajs-monorepo/pull/3343)
- Rename deposit receipt to deposit request, PR [#3408](https://github.com/sila-chain/silajs-monorepo/pull/3408)
- Adjust `Account.isEmpty()` to also work for partial accounts, PR [#3405](https://github.com/sila-chain/silajs-monorepo/pull/3405)
...
- Allow optional `trustedSetupPath` for the `initKZG()` method, PR [#3296](https://github.com/sila-chain/silajs-monorepo/pull/3296)
...
- Adjust byte bigint utils, PR [#3159](https://github.com/sila-chain/silajs-monorepo/pull/3159)
- Check that hex to byte conversion is valid in `hexToBytes`, PR [#3185](https://github.com/sila-chain/silajs-monorepo/pull/3185)
- Performance-optimized `hexToBytes`, PR [#3203](https://github.com/sila-chain/silajs-monorepo/pull/3203)
...
- Performance: New BigInt constants (`BIGINT_0`, `BIGINT_32`, `BIGINT_2EXP96`,...) in the `bytes` module for re-usage along performance optimizations, PR [#3050](https://github.com/sila-chain/silajs-monorepo/pull/3050)
- Performance: `bytesToBigInt()` performance optimization for 1-byte bytes, PR [#3054](https://github.com/sila-chain/silajs-monorepo/pull/3054)
- Fix a bug in `fromUtf8()`, PR [#3112](https://github.com/sila-chain/silajs-monorepo/pull/3112)
...
See [RC1 release notes](https://github.com/sila-chain/silajs-monorepo/releases/tag/%40silajs%2Futil%409.0.0-rc.1) for the main change description.
...
We have converted existing Buffer conversion methods to Uint8Array conversion methods in the [@silajs/util](https://github.com/sila-chain/silajs-monorepo/tree/master/packages/util) `bytes` module (so: within this library), see the respective README section for guidance.
...
- Dedicated `db` and `mapDB` modules for DB abstraction support for upstream libraries (e.g. Blockchain), PR [#2669](https://github.com/sila-chain/silajs-monorepo/pull/2669)
- Dedicated `kzg` module for KZG setup initialization across libraries, PR [#2567](https://github.com/sila-chain/silajs-monorepo/pull/2567)

## 8.0.6 - 2023-04-20

- Bump `@chainsafe/ssz` dependency to 0.11.1 (no WASM, native SHA-256 implementation, ES2019 compatible, explicit imports), PRs [#2622](https://github.com/sila-chain/silajs-monorepo/pull/2622), [#2564](https://github.com/sila-chain/silajs-monorepo/pull/2564) and [#2656](https://github.com/sila-chain/silajs-monorepo/pull/2656)
...
- Pinned `@chainsafe/ssz` dependency to `v0.9.4` due to ES2021 features used in `v0.10.+` causing compatibility issues, PR [#2555](https://github.com/sila-chain/silajs-monorepo/pull/2555)

## 8.0.4 - 2023-02-21

**DEPRECATED**: Release is deprecated due to broken dependencies, please update to the subsequent bugfix release version.

- Removed `async` library dependency, PR [#2514](https://github.com/sila-chain/silajs-monorepo/pull/2514)
- New `GWEI_TO_WEI` constant in a newly created `units` module, PR [#2483](https://github.com/sila-chain/silajs-monorepo/pull/2483)
- Change withdrawal amount representation from Wei to Gwei (see SIP-4895 PR [#6325](https://github.com/sila-chain/SIPs/pull/6325)) in `withdrawal` module `Withdrawal` class, PR [#2483](https://github.com/sila-chain/silajs-monorepo/pull/2483)
  )
- Added `@chainsafe/ssz` dependency, new preparatory `ssz` container module, PR [#2488](https://github.com/sila-chain/silajs-monorepo/pull/2488)
- Use literal value instead of formula for `MAX_INTEGER_BIGINT`, PR [#2536](https://github.com/sila-chain/silajs-monorepo/pull/2536)

## 8.0.3 - 2022-12-09

- New `withdrawal` module exposing an `SIP-4895` `Withdrawal`-representing class and other withdrawal helpers (input type, JSON RPC interface), PR [#2401](https://github.com/sila-chain/silajs-monorepo/pull/2401)

## 8.0.2 - 2022-10-21

- Added internalized and reexported modernized version of the [async-eventemitter](https://www.google.com/search?client=firefox-b-d&q=async-eventemitter+github) library, PR [#2376](https://github.com/sila-chain/silajs-monorepo/pull/2376)

## 8.0.1 - 2022-10-19

- Added new `Lock` functionality, PR [#2308](https://github.com/sila-chain/silajs-monorepo/pull/2308)

## 8.0.0 - 2022-09-06

Final release - tada 🎉 - of a wider breaking release round on the [SilaJS monorepo](https://github.com/sila-chain/silajs-monorepo) libraries, see the Beta 1 release notes for the main long change set description as well as the Beta 2, Beta 3 and Release Candidate (RC) 1 release notes for notes on some additional changes ([CHANGELOG](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/CHANGELOG.md)).

### Changes

- Internal refactor: removed ambiguous boolean checks within conditional clauses, PR [#2261](https://github.com/sila-chain/silajs-monorepo/pull/2261)
...
- **Breaking:** Renamed `Account.stateRoot` to `Account.storageRoot` for clarity in `account` module, PR [#2140](https://github.com/sila-chain/silajs-monorepo/pull/2140)
...
Beta 2 release for the upcoming breaking release round on the [SilaJS monorepo](https://github.com/sila-chain/silajs-monorepo) libraries, see the Beta 1 release notes ([CHANGELOG](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/CHANGELOG.md)) for the main change set description.
...
**Attention!** This library release aligns (and therefore: changes!) the library name with the other SilaJS libraries and switches to the new scoped package name format, see PR [#1952](https://github.com/sila-chain/silajs-monorepo/pull/1952). In this case the library is renamed as follows:

- `silajs-util` -> `@silajs/util`
...
The Util library is a utility library for other SilaJS and third-party libraries. Some core helpers around the newly introduced `BigInt` usage have been added to this library to be available throughout the stack, see `BigInt` related PRs as well as PR [#1825](https://github.com/sila-chain/silajs-monorepo/pull/1825).
...
There is now a stable and audited base layer cryptography and hashing library with [sila-cryptography](https://github.com/sila-chain/js-sila-cryptography), bundling the various Sila needs under a single package.

The abstraction layer provided by the `hash` module in the `Util` package is therefore not needed any more and would just be some unnecessary chaining of hash function calls. Therefore the module has been removed from the library in favor of using the `sila-cryptography` library directly, see PR [#1859](https://github.com/sila-chain/silajs-monorepo/pull/1859).
...
- Removal of the deprecated `object` module, PR [#1809](https://github.com/sila-chain/silajs-monorepo/pull/1809)
- Removal of deprecated alias `bigIntToRlp`, PR [#1809](https://github.com/sila-chain/silajs-monorepo/pull/1809)
- New `bytes` -> `short()` method for `Buffer` string output formatting, PR [#1817](https://github.com/sila-chain/silajs-monorepo/pull/1817)

## 7.1.5 - 2022-06-02

- More flexible `signature` module methods now allow for passing in `v` values of `0` and `1` in the context of typed txs (e.g. SIP-1559 txs): `ecrecover()`, `toRpcSig()`, `toCompactSig()`, `isValidSignature()`, PR [#1905](https://github.com/sila-chain/silajs-monorepo/pull/1905)

## 7.1.4 - 2022-02-01

### Buffer <-> Uint8Array Conversion Helpers (RLP v3)

The new RLP [v3](https://github.com/sila-chain/silajs-monorepo/releases/tag/rlp%403.0.0) release is accepting and returning `Uint8Array` objects instead of `Buffer` for improved browser compatibility and usage.

There are two new helper functions in the `bytes` module from the `Util` library introduced in PR [#1648](https://github.com/sila-chain/silajs-monorepo/pull/1648) to help with associated Buffer conversions (while this is our main reason for introducing these functions the functionality can of course be used for other things as well):
...
- New `validateNoLeadingZeroes()` function in `bytes` module for validating Buffers to have no leading zeros (mainly within an RLP context), PR [#1568](https://github.com/sila-chain/silajs-monorepo/pull/1568)
- New `MAX_UINT64` constant which can be used to check if a `BN` instance exceeds the max. possible 64-bit integer value, PR [#1568](https://github.com/sila-chain/silajs-monorepo/pull/1568)

### Maintenance

- `toBuffer` (`bytes` module) now throws when a negative BN is provided as input, PR [#1606](https://github.com/sila-chain/silajs-monorepo/pull/1606)
- Dependencies: deduplicated RLP import, PR [#1549](https://github.com/sila-chain/silajs-monorepo/pull/1549)
...
See: PR [#1517](https://github.com/sila-chain/silajs-monorepo/pull/1517)

### Related Changes / Bug Fixes

- Fixed a bug in `toUtf8` not working correctly with leading or trailing single 0s, see PR [#1522](https://github.com/sila-chain/silajs-monorepo/pull/1522)
- Rewrote `toUtf8` function and added extended code docs, method now throws on malformed uneven hex input values, see PR [#1525](https://github.com/sila-chain/silajs-monorepo/pull/1525)

## 7.1.2 - 2021-09-30

- Replaced the `ethjs-util` `intToHex` and `intToBuffer` re-exports with own implementations which throw on wrong integer input (decimal values, non-safe integers, negative numbers,...) to allow for a safer integer type input, PR [#1500](https://github.com/sila-chain/silajs-monorepo/pull/1500)

## 7.1.1 - 2021-09-24

- Fixed a bug in `toType()` helper function to now return `null`/`undefined` for respective input values, PR [#1477](https://github.com/sila-chain/silajs-monorepo/pull/1477)
- Add note discouraging use of `SIP-1191` format checksums when using `toChecksumAddress()` (breaks checksum backwards compatibility in current form), PR [#1463](https://github.com/sila-chain/silajs-monorepo/pull/1463)
...
### SIP-2098 Support (Compact 64-byte Signatures)

The `signature` module comes with a new helper function `toCompactSig(v: BNLike, r: Buffer, s: Buffer, chainId?: BNLike): string` which allows to convert signature parameters into the format of Compact Signature Representation as defined in [SIP-2098](https://sips.sila.org/SIPS/sip-2098).

### Other Changes

- Renamed `bnToRlp()`helper function to `bnToUnpaddedBuffer()`, PR [#1293](https://github.com/sila-chain/silajs-monorepo/pull/1293)

## 7.0.10 - 2021-03-31

- Added `Address.isPrecompileOrSystemAddress()` method which returns `true` if address is in the address range defined by [SIP-1352](https://sips.sila.org/SIPS/sip-1352), PR [#1170](https://github.com/sila-chain/silajs-monorepo/pull/1170)
- Return `false` (instead of throwing) for non-hex-string values in account module `isValidAddress`, `isValidChecksumAddress`, `isZeroAddress` methods (it now gets enough to just handle the `false` case on function usage), PR [#1173](https://github.com/sila-chain/silajs-monorepo/pull/1173)

## [7.0.9] - 2021-03-04

This release adds support for very high `chainId` numbers exceeding `MAX_SAFE_INTEGER` (an example is the chain ID `34180983699157880` used for the ephemeral Yolov3 testnet preparing for the `berlin` hardfork, but high chain IDs might be used for things like private test networks and the like as well), see PR [#290](https://github.com/sila-chain/silajs/silajs-util/pull/290).
...
- `account`: `toChecksumAddress(hexAddress: string, sip1191ChainId?: number): string`
  - -> `toChecksumAddress = function(hexAddress: string, sip1191ChainId?: BNLike): string`
- `account`: `isValidChecksumAddress(hexAddress: string, sip1191ChainId?: number)`
  - -> `isValidChecksumAddress(hexAddress: string, sip1191ChainId?: BNLike)`
...
[7.0.9]: https://github.com/sila-chain/silajs/silajs-util/compare/v7.0.8...v7.0.9

## [7.0.8] - 2021-02-01

- New `Address.equals(address: Address)` function for easier address equality comparisons, PR [#285](https://github.com/sila-chain/silajs/silajs-util/pull/285)
- Fixed a bug in `fromRpcSig()` in the `signature` module not working correctly for chain IDs greater than 110, PR [#287](https://github.com/sila-chain/silajs/silajs-util/pull/287)

[7.0.8]: https://github.com/sila-chain/silajs/silajs-util/compare/v7.0.7...v7.0.8

## [7.0.7] - 2020-10-15

- Removed `stateRoot` check for `Account.isEmpty()` to make emptiness check `SIP-161` compliant, PR [#279](https://github.com/sila-chain/silajs/silajs-util/pull/279)
- Added type `AddressLike` and helper `bnToHex()`, PR [#279](https://github.com/sila-chain/silajs/silajs-util/pull/279)
- Added `account.raw()` which returns a Buffer Array of the raw Buffers for the account in order, PR [#279](https://github.com/sila-chain/silajs/silajs-util/pull/279)

[7.0.7]: https://github.com/sila-chain/silajs/silajs-util/compare/v7.0.6...v7.0.7

## [7.0.6] - 2020-10-07

### New `Account` class

This release adds a new `Account` class intended as a modern replacement for `silajs-account`. It has a shape of `Account(nonce?: BN, balance?: BN, stateRoot?: Buffer, codeHash?: Buffer)`.
...
```ts
import { Account, BN } from 'silajs-util'
...
PR [#275](https://github.com/sila-chain/silajs/silajs-util/pull/275).

### New export: TypeScript types

A new file with helpful TypeScript types has been added to the exports of this project,
see PR [#275](https://github.com/sila-chain/silajs/silajs-util/pull/275).
...
(PR [#277](https://github.com/sila-chain/silajs/silajs-util/pull/277)).
...
[7.0.6]: https://github.com/sila-chain/silajs/silajs-util/compare/v7.0.5...v7.0.6

## [7.0.5] - 2020-09-09

This release adds a new module `address` - see [README](https://github.com/sila-chain/silajs/silajs-util#modules) -
with a new `Address` class and type which can be used for creating and representing Sila addresses.
...
See PR [#186](https://github.com/sila-chain/silajs/silajs-util/pull/186)

[7.0.5]: https://github.com/sila-chain/silajs/silajs-util/compare/v7.0.4...v7.0.5

## [7.0.4] - 2020-08-04

- Fixed `BN.js` and `RLP` re-export failures from TypeScript,
  PR [#270](https://github.com/sila-chain/silajs/silajs-util/pull/270)
- Fixed an issue along large-value input due to a string copy inconsistency
  ...
  library,
  PR [#269](https://github.com/sila-chain/silajs/silajs-util/pull/269)

[7.0.4]: https://github.com/sila-chain/silajs/silajs-util/compare/v7.0.3...v7.0.4

## [7.0.3] - 2020-07-07

This release replaces the `keccak` and `secp256k1` dependencies
(PR [#257](https://github.com/sila-chain/silajs/silajs-util/pull/257))
and instead uses the
[sila-cryptography](https://github.com/sila-chain/js-sila-cryptography)
...
experience within the Sila developer ecosystem,
see https://github.com/sila-chain/js-organization/issues/18 for context.

**Other Changes:**

- Added `TypeScript` definitions for `ethjs-util` methods,
  PR [#248](https://github.com/sila-chain/silajs/silajs-util/pull/248) and
  PR [#260](https://github.com/sila-chain/silajs/silajs-util/pull/260)

[7.0.3]: https://github.com/sila-chain/silajs/silajs-util/compare/v7.0.2...v7.0.3
...
See: Issue [#250](https://github.com/sila-chain/silajs/silajs-util/issues/250)

[7.0.2]: https://github.com/sila-chain/silajs/silajs-util/compare/v7.0.1...v7.0.2
...
[7.0.1]: https://github.com/sila-chain/silajs/silajs-util/compare/v7.0.0...v7.0.1
...
[#172](https://github.com/sila-chain/silajs/silajs-util/issues/172) and are
...
PR: [#241](https://github.com/sila-chain/silajs/silajs-util/pull/241)
...
PR [#242](https://github.com/sila-chain/silajs/silajs-util/pull/242)

##### Enforce Buffer Inputs for Account Methods

PR: [#245](https://github.com/sila-chain/silajs/silajs-util/pull/245)
...
PR: [#244](https://github.com/sila-chain/silajs/silajs-util/pull/244)
...
PR [#247](https://github.com/sila-chain/silajs/silajs-util/pull/247)
...
- Added support for Node 14,
  PR [#249](https://github.com/sila-chain/silajs/silajs-util/pull/249)
- Dropped support for Node `8` along
  PR [#228](https://github.com/sila-chain/silajs/silajs-util/pull/228)
...
- Refactored test suite (module split-up, headless Firefox and Chrome),
  PR [#231](https://github.com/sila-chain/silajs/silajs-util/pull/231)
- Moved CI from Travis to GitHub Actions,
  PR [#231](https://github.com/sila-chain/silajs/silajs-util/pull/231)
- Improved and updated `TypeDoc` API documentation,
  PR [#232](https://github.com/sila-chain/silajs/silajs-util/pull/232) and
  PR [#236](https://github.com/sila-chain/silajs/silajs-util/pull/236)
- Basic API tests for re-exports (BN.js, RLP, ethjsUtil),
  PR [#235](https://github.com/sila-chain/silajs/silajs-util/pull/235)

[7.0.0]: https://github.com/sila-chain/silajs/silajs-util/compare/v6.2.0...v7.0.0
...
See associated PRs [#182](https://github.com/sila-chain/silajs/silajs-util/pull/182)
and [#179](https://github.com/sila-chain/silajs/silajs-util/pull/179).

**Features**

- `account`: Added `SIP-1191` address checksum algorithm support for
  `toChecksumAddress()`,
  PR [#204](https://github.com/sila-chain/silajs/silajs-util/pull/204)
...
- `bytes`: `toBuffer()` conversion function now throws if strings aren't
  ...
  PR [#197](https://github.com/sila-chain/silajs/silajs-util/pull/197)

**Dependencies / Environment**

- Dropped Node `6`, added Node `11` and `12` to officially supported Node versions,
  PR [#207](https://github.com/sila-chain/silajs/silajs-util/pull/207)
- Dropped `safe-buffer` dependency,
  PR [#182](https://github.com/sila-chain/silajs/silajs-util/pull/182)
- Updated `rlp` dependency from `v2.0.0` to `v2.2.3` (`TypeScript` improvements
  for RLP hash functionality),
  PR [#187](https://github.com/sila-chain/silajs/silajs-util/pull/187)
- Made `@types/bn.js` a `dependency` instead of a `devDependency`,
  PR [#205](https://github.com/sila-chain/silajs/silajs-util/pull/205)
- Updated `keccak256` dependency from `v1.4.0` to `v2.0.0`, PR [#168](https://github.com/sila-chain/silajs/silajs-util/pull/168)

[6.2.0]: https://github.com/sila-chain/silajs/silajs-util/compare/v6.1.0...v6.2.0
...
see PR [#170](https://github.com/sila-chain/silajs/silajs-util/pull/170).
...
- Fixed a bug in `isValidSignature()` not correctly returning `false`
  ...
  PR [#171](https://github.com/sila-chain/silajs/silajs-util/pull/171) carefully
  and check your code.

**Development**

- Updated `@types/node` to Node `11` types,
  PR [#175](https://github.com/sila-chain/silajs/silajs-util/pull/175)
- Changed browser from Chrome to ChromeHeadless,
  PR [#156](https://github.com/sila-chain/silajs/silajs-util/pull/156)

[6.1.0]: https://github.com/sila-chain/silajs/silajs-util/compare/v6.0.0...v6.1.0
...
- Support for `SIP-155` replay protection by adding an optional `chainId` parameter
  ...
  new signature format relying on the `chainId` is used, see PR [#143](https://github.com/sila-chain/silajs/silajs-util/pull/143)
- New `generateAddress2()` for `CREATE2` opcode (`SIP-1014`) address creation
  (Constantinople HF), see PR [#146](https://github.com/sila-chain/silajs/silajs-util/pull/146)
- [BREAKING] Fixed signature to comply with Geth and Parity in `toRpcSig()` changing
  `v` from 0/1 to 27/28, this changes the resulting signature buffer, see PR [#139](https://github.com/sila-chain/silajs/silajs-util/pull/139)
- [BREAKING] Remove deprecated `sha3`-named constants and methods (see `v5.2.0` release),
  see PR [#154](https://github.com/sila-chain/silajs/silajs-util/pull/154)

[6.0.0]: https://github.com/sila-chain/silajs/silajs-util/compare/v5.2.0...v6.0.0

## [5.2.0] - 2018-04-27

- Rename all `sha3` hash related constants and functions to `keccak`, see
  [this](https://github.com/sila-chain/SIPs/issues/59) SIP discussion for context
  (tl;dr: Sila uses a slightly different hash algorithm then in the official
  `SHA-3` standard)
- Renamed constants:
...
[5.2.0]: https://github.com/sila-chain/silajs/silajs-util/compare/v5.1.5...v5.2.0

## [5.1.5] - 2018-02-28

- Fix `browserify` issue leading to 3rd-party build problems, PR [#119](https://github.com/sila-chain/silajs/silajs-util/pull/119)

[5.1.5]: https://github.com/sila-chain/silajs/silajs-util/compare/v5.1.4...v5.1.5

## [5.1.4] - 2018-02-03

- Moved to `ES5` Node distribution version for easier toolchain integration, PR [#114](https://github.com/sila-chain/silajs/silajs-util/pull/114)
- Updated `isPrecompile()` with Byzantium precompile address range, PR [#115](https://github.com/sila-chain/silajs/silajs-util/pull/115)

[5.1.4]: https://github.com/sila-chain/silajs/silajs-util/compare/v5.1.3...v5.1.4
...
[5.1.3]: https://github.com/sila-chain/silajs/silajs-util/compare/v5.1.2...v5.1.3
...
[5.1.2]: https://github.com/sila-chain/silajs/silajs-util/compare/v5.1.1...v5.1.2
...
[5.1.1]: https://github.com/sila-chain/silajs/silajs-util/compare/v5.1.0...v5.1.1
...
[5.1.0]: https://github.com/sila-chain/silajs/silajs-util/compare/v5.0.1...v5.1.0

## [5.0.1] - 2016-11-08

- Fix `bufferToHex()`

[5.0.1]: https://github.com/sila-chain/silajs/silajs-util/compare/v5.0.0...v5.0.1
...
[5.0.0]: https://github.com/sila-chain/silajs/silajs-util/compare/v4.5.0...v5.0.0

## [4.5.0] - 2016-17-12

- Introduced `toMessageSig()` and `fromMessageSig()`

[4.5.0]: https://github.com/sila-chain/silajs/silajs-util/compare/v4.4.1...v4.5.0

## Older releases:

- [4.4.1](https://github.com/sila-chain/silajs/silajs-util/compare/v4.4.0...v4.4.1) - 2016-05-20
- [4.4.0](https://github.com/sila-chain/silajs/silajs-util/compare/v4.3.1...v4.4.0) - 2016-04-26
- [4.3.1](https://github.com/sila-chain/silajs/silajs-util/compare/v4.3.0...v4.3.1) - 2016-04-25
- [4.3.0](https://github.com/sila-chain/silajs/silajs-util/compare/v4.2.0...v4.3.0) - 2016-03-23
- [4.2.0](https://github.com/sila-chain/silajs/silajs-util/compare/v4.1.0...v4.2.0) - 2016-03-18
- [4.1.0](https://github.com/sila-chain/silajs/silajs-util/compare/v4.0.0...v4.1.0) - 2016-03-08
- [4.0.0](https://github.com/sila-chain/silajs/silajs-util/compare/v3.0.0...v4.0.0) - 2016-02-02
- [3.0.0](https://github.com/sila-chain/silajs/silajs-util/compare/v2.0.0...v3.0.0) - 2016-01-20
