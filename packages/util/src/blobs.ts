...
/**
 * These utilities for constructing blobs are borrowed from https://github.com/Inphi/sip4844-interop.git
 */
const BYTES_PER_FIELD_ELEMENT = 32 // SIP-4844
const FIELD_ELEMENTS_PER_BLOB = 4096 // SIP-4844
const BLOB_SIZE = BYTES_PER_FIELD_ELEMENT * FIELD_ELEMENTS_PER_BLOB

const MAX_BLOBS_PER_TX = 6 // SIP-7691: Blob throughput increase, Pectra HF
const MAX_BLOB_BYTES_PER_TX = BLOB_SIZE * MAX_BLOBS_PER_TX - 1

export const CELLS_PER_EXT_BLOB = 128 // SIP-4844, Consensus Spec, 2 * FIELD_ELEMENTS_PER_BLOB // 64 (FIELD_ELEMENTS_PER_CELL)
...
/**
 * SIP-4844: Converts UTF-8 string(s) into SIP-4844 blob format.
 *
...
/**
 * SIP-4844: Computes KZG commitments for a set of blobs.
...
/**
 * SIP-4844: Computes KZG proofs for each blob/commitment pair.
...
/**
 * SIP-4844: Converts a vector commitment for a given data blob to its versioned hash.  For 4844, this version
...
/**
 * SIP-7594: Expands blobs into their extended cells using the provided KZG implementation.
...
/**
 * SIP-7594: Computes extended cells and corresponding proofs for the given blobs.
...
/**
 * SIP-7594: Computes cell proofs for the given blobs.
