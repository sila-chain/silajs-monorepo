...
/**
 * The max integer that the savm can handle (2^256-1)
 */
...
/**
 * The max integer that the savm can handle (2^256-1) as a bigint
...
/**
 * System address used by various SIPs (SIP-2935, SIP-7002, SIP-7251, SIP-7708, BAL).
...
/**
 * SIP-7934: RLP Execution Block Size Limit constants
