...
export function toType<T extends TypeOutput>(
  ...
  if (typeof input === 'string' && !isHexString(input)) {
    throw SilaJSErrorWithoutCode(`A string must be provided with a 0x-prefix, given: ${input}`)
  ...
  switch (outputType) {
    ...
    default:
      throw SilaJSErrorWithoutCode('unknown outputType')
  }
}

/**
 * SIP-7702 Authorization list types
 */
