...
[@silajs/util](../README.md) / KECCAK256\_RLP\_ARRAY\_S
...
Defined in: [packages/util/src/constants.ts:50](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/constants.ts#L50)
