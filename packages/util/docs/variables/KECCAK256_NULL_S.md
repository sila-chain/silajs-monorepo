...
[@silajs/util](../README.md) / KECCAK256\_NULL\_S
...
Defined in: [packages/util/src/constants.ts:40](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/constants.ts#L40)
