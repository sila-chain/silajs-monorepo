...
[@silajs/util](../README.md) / KECCAK256\_RLP\_S
...
Defined in: [packages/util/src/constants.ts:61](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/constants.ts#L61)
