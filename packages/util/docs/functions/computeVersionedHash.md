...
[@silajs/util](../README.md) / computeVersionedHash

# Function: computeVersionedHash()

> **computeVersionedHash**(`commitment`, `blobCommitmentVersion`): `` `0x${string}` ``

Defined in: [packages/util/src/blobs.ts:131](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/blobs.ts#L131)
