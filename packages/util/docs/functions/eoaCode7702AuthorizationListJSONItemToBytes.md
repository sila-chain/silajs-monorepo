...
[@silajs/util](../README.md) / eoaCode7702AuthorizationListJSONItemToBytes
...
Defined in: [packages/util/src/authorization.ts:51](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/authorization.ts#L51)
