...
[@silajs/util](../README.md) / blobsToCellsAndProofs

# Function: blobsToCellsAndProofs()

> **blobsToCellsAndProofs**(`kzg`, `blobs`): \[`` `0x${string}` ``[], `` `0x${string}` ``[], `number`[]\]

Defined in: [packages/util/src/blobs.ts:179](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/blobs.ts#L179)
