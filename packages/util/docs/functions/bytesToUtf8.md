...
[@silajs/util](../README.md) / bytesToUtf8

# Function: bytesToUtf8()

> **bytesToUtf8**(`bytes`): `string`

Defined in: [packages/util/src/bytes.ts:533](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/bytes.ts#L533)
