...
[@silajs/util](../README.md) / decodeBinaryTreeLeafBasicData
...
Defined in: [packages/util/src/binaryTree.ts:245](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/binaryTree.ts#L245)
