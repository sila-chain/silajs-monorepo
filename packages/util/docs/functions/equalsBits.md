...
[@silajs/util](../README.md) / equalsBits

# Function: equalsBits()

> **equalsBits**(`bits1`, `bits2`): `boolean`

Defined in: [packages/util/src/bytes.ts:649](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/bytes.ts#L649)
