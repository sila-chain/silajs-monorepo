...
[@silajs/util](../README.md) / blobsToProofs

# Function: blobsToProofs()

> **blobsToProofs**(`kzg`, `blobs`, `commitments`): `` `0x${string}` ``[]

Defined in: [packages/util/src/blobs.ts:111](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/blobs.ts#L111)
