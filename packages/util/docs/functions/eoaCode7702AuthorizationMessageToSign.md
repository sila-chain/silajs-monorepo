...
[@silajs/util](../README.md) / eoaCode7702AuthorizationMessageToSign

# Function: eoaCode7702AuthorizationMessageToSign()

> **eoaCode7702AuthorizationMessageToSign**(`input`): `Uint8Array`\<`ArrayBuffer`\>

Defined in: [packages/util/src/authorization.ts:89](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/authorization.ts#L89)
