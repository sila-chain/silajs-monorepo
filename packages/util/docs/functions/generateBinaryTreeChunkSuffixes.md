...
[@silajs/util](../README.md) / generateBinaryTreeChunkSuffixes

# Function: generateBinaryTreeChunkSuffixes()

> **generateBinaryTreeChunkSuffixes**(`numChunks`): `number`[]

Defined in: [packages/util/src/binaryTree.ts:304](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/binaryTree.ts#L304)
