...
[@silajs/util](../README.md) / isValidSignature

# Function: isValidSignature()

> **isValidSignature**(`v`, `r`, `s`, `homesteadOrLater`, `chainId?`): `boolean`

Defined in: [packages/util/src/signature.ts:158](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/signature.ts#L158)
