...
[@silajs/util](../README.md) / encodeBinaryTreeLeafBasicData

# Function: encodeBinaryTreeLeafBasicData()

> **encodeBinaryTreeLeafBasicData**(`account`): `Uint8Array`

Defined in: [packages/util/src/binaryTree.ts:280](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/binaryTree.ts#L280)
...
SIP-7864. Additionally, 4 bytes are reserved for future use as specified
in SIP-7864.
