...
[@silajs/util](../README.md) / matchingBytesLength

# Function: matchingBytesLength()

> **matchingBytesLength**(`bytes1`, `bytes2`): `number`

Defined in: [packages/util/src/bytes.ts:606](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/bytes.ts#L606)
