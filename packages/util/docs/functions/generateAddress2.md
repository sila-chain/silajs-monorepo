...
[@silajs/util](../README.md) / generateAddress2

# Function: generateAddress2()

> **generateAddress2**(`from`, `salt`, `initCode`): `Uint8Array`

Defined in: [packages/util/src/account.ts:473](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/account.ts#L473)
