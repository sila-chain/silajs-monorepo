...
[@silajs/util](../README.md) / eoaCode7702AuthorizationHashedMessageToSign
...
Defined in: [packages/util/src/authorization.ts:113](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/authorization.ts#L113)
