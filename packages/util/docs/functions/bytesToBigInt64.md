...
[@silajs/util](../README.md) / bytesToBigInt64

# Function: bytesToBigInt64()

> **bytesToBigInt64**(`bytes`, `littleEndian`): `bigint`

Defined in: [packages/util/src/bytes.ts:489](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/bytes.ts#L489)
