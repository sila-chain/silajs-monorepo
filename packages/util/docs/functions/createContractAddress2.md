...
[@silajs/util](../README.md) / createContractAddress2

# Function: createContractAddress2()

> **createContractAddress2**(`from`, `salt`, `initCode`): [`Address`](../classes/Address.md)

Defined in: [packages/util/src/address.ts:146](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/address.ts#L146)
