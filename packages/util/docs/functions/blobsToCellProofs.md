...
[@silajs/util](../README.md) / blobsToCellProofs

# Function: blobsToCellProofs()

> **blobsToCellProofs**(`kzg`, `blobs`): `` `0x${string}` ``[]

Defined in: [packages/util/src/blobs.ts:207](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/blobs.ts#L207)
