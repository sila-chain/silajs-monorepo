...
[@silajs/util](../README.md) / bytesToBits

# Function: bytesToBits()

> **bytesToBits**(`bytes`, `bitLength?`): `number`[]

Defined in: [packages/util/src/bytes.ts:569](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/bytes.ts#L569)
