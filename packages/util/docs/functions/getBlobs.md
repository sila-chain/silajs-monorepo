...
[@silajs/util](../README.md) / getBlobs

# Function: getBlobs()

> **getBlobs**(`input`): `` `0x${string}` ``[]

Defined in: [packages/util/src/blobs.ts:62](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/blobs.ts#L62)
