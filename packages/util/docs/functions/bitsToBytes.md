...
[@silajs/util](../README.md) / bitsToBytes

# Function: bitsToBytes()

> **bitsToBytes**(`bits`): `Uint8Array`

Defined in: [packages/util/src/bytes.ts:587](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/bytes.ts#L587)
