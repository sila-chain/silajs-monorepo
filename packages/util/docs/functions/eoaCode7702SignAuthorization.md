...
[@silajs/util](../README.md) / eoaCode7702SignAuthorization
...
Defined in: [packages/util/src/authorization.ts:127](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/authorization.ts#L127)
