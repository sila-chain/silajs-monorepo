...
[@silajs/util](../README.md) / eoaCode7702RecoverAuthority

# Function: eoaCode7702RecoverAuthority()

> **eoaCode7702RecoverAuthority**(`input`): [`Address`](../classes/Address.md)

Defined in: [packages/util/src/authorization.ts:163](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/authorization.ts#L163)
