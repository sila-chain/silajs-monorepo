...
[@silajs/util](../README.md) / setLengthLeft

# Function: setLengthLeft()

> **setLengthLeft**(`msg`, `length`, `opts`): `Uint8Array`

Defined in: [packages/util/src/bytes.ts:170](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/bytes.ts#L170)
