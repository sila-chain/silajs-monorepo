...
[@silajs/util](../README.md) / withdrawalToBytesArray

# Function: withdrawalToBytesArray()

> **withdrawalToBytesArray**(`withdrawal`): [`WithdrawalBytes`](../type-aliases/WithdrawalBytes.md)

Defined in: [packages/util/src/withdrawal.ts:36](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/withdrawal.ts#L36)
