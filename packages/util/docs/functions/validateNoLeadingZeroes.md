...
[@silajs/util](../README.md) / validateNoLeadingZeroes

# Function: validateNoLeadingZeroes()

> **validateNoLeadingZeroes**(`values`): `void`

Defined in: [packages/util/src/bytes.ts:363](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/bytes.ts#L363)
