...
[@silajs/util](../README.md) / eoaCode7702AuthorizationListBytesItemToJSON
...
Defined in: [packages/util/src/authorization.ts:32](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/authorization.ts#L32)
