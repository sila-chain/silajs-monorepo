...
[@silajs/util](../README.md) / hashBlockAccessListFromJSON

# Function: hashBlockAccessListFromJSON()

> **hashBlockAccessListFromJSON**(`json`): `Uint8Array`

Defined in: [packages/util/src/bal/validation.ts:105](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/bal/validation.ts#L105)
