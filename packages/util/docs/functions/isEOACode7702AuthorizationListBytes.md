...
[@silajs/util](../README.md) / isEOACode7702AuthorizationListBytes
...
Defined in: [packages/util/src/types.ts:160](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/types.ts#L160)
