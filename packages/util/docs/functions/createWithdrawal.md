...
[@silajs/util](../README.md) / createWithdrawal

# Function: createWithdrawal()

> **createWithdrawal**(`withdrawalData`): [`Withdrawal`](../classes/Withdrawal.md)

Defined in: [packages/util/src/withdrawal.ts:106](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/withdrawal.ts#L106)
