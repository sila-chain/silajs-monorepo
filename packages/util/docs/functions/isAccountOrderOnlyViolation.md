...
[@silajs/util](../README.md) / isAccountOrderOnlyViolation

# Function: isAccountOrderOnlyViolation()

> **isAccountOrderOnlyViolation**(`json`): `boolean`

Defined in: [packages/util/src/bal/validation.ts:96](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/bal/validation.ts#L96)
