...
[@silajs/util](../README.md) / matchingBitsLength

# Function: matchingBitsLength()

> **matchingBitsLength**(`bits1`, `bits2`): `number`

Defined in: [packages/util/src/bytes.ts:627](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/bytes.ts#L627)
