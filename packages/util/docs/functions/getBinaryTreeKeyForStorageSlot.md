...
[@silajs/util](../README.md) / getBinaryTreeKeyForStorageSlot
...
Defined in: [packages/util/src/binaryTree.ts:226](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/binaryTree.ts#L226)
