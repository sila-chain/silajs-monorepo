...
[@silajs/util](../README.md) / isHexString

# Function: isHexString()

> **isHexString**(`value`, `length?`): `` value is `0x${string}` ``

Defined in: [packages/util/src/internal.ts:36](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/internal.ts#L36)
