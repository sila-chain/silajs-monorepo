...
[@silajs/util](../README.md) / BatchDBOp
...
Defined in: [packages/util/src/db.ts:4](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/db.ts#L4)
