...
[@silajs/util](../README.md) / EOACode7702AuthorizationListItem
...
Defined in: [packages/util/src/types.ts:140](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/util/src/types.ts#L140)
