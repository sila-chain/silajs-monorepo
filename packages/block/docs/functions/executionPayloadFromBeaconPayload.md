...
[@silajs/block](../README.md) / executionPayloadFromBeaconPayload
...
Defined in: [from-beacon-payload.ts:41](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/block/src/from-beacon-payload.ts#L41)
...
The JSON data can be retrieved from a consensus layer (CL) client on this Beacon API `/sil/v2/beacon/blocks/[block number]`
