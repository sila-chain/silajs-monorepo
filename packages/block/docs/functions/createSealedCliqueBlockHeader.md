...
[@silajs/block](../README.md) / createSealedCliqueBlockHeader
...
Defined in: [header/constructors.ts:87](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/block/src/header/constructors.ts#L87)
