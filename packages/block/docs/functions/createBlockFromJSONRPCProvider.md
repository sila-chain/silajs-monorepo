...
[@silajs/block](../README.md) / createBlockFromJSONRPCProvider
...
Defined in: [block/constructors.ts:246](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/block/src/block/constructors.ts#L246)
