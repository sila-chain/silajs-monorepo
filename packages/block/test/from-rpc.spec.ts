...
import { bytesToHex, equalsBytes, hexToBytes, randomBytes } from '@silajs/util'
...
import type { JSONRPCTx, LegacyTx } from '@silajs/tx'
...
describe('[fromRPC]:', () => {
  ...
  it('should create a block with SIP-4896 withdrawals', async () => {
  ...
  it('should create a block header with the correct hash when SIP-4896 withdrawals are present', () => {
    const common = new Common({ chain: SilaMainnet, hardfork: Hardfork.SilaShanghai })
...
describe('[fromRPC] - Alchemy/Infura API block responses', () => {
  ...
  it('should correctly parse a cancun block over rpc', () => {
    const common = new Common({ chain: goerliChainConfig, hardfork: Hardfork.SilaCancun })
