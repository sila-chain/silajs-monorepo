...
import type { WithdrawalBytes, WithdrawalData } from '@silajs/util'
...
const common = new Common({
  chain: SilaMainnet,
  hardfork: Hardfork.SilaShanghai,
})
...
describe('SIP4895 tests', () => {
  ...
  it('Header tests', () => {
    ...
    assert.throws(
      ...
      undefined,
      undefined,
      'should throw when setting withdrawalsRoot with SIP4895 not being activated',
    )
    assert.doesNotThrow(() => {
      createBlockHeader(
        {},
    ...
    }, 'should not throw when withdrawalsRoot is undefined with SIP4895 being activated')
    assert.doesNotThrow(() => {
      createBlockHeader(
        {
          withdrawalsRoot: new Uint8Array(32),
    ...
    }, 'correctly instantiates an SIP4895 block header')
  })
  it('Block tests', async () => {
    ...
    assert.throws(
      ...
      undefined,
      undefined,
      'should throw when setting withdrawals with SIP4895 not being activated',
    )
    assert.doesNotThrow(() => {
      createBlock(
        {},
    ...
    }, 'should not throw when withdrawals is undefined with SIP4895 being activated')
    assert.doesNotThrow(() => {
      createBlock(
        {
          header: {
