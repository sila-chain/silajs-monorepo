...
import { goerliBlocks, goerliChainConfig, sila-mainnetBlocks } from '@silajs/testdata'
import {
  KECCAK256_RLP,
  KECCAK256_RLP_ARRAY,
  bytesToHex,
...
*/
  ...
  it('should test hash() function', () => {
    let common = new Common({ chain: SilaMainnet, hardfork: Hardfork.Chainstart })
    let header = createBlockHeader(sila-mainnetBlocks[0]['header'], { common })
    assert.strictEqual(
      bytesToHex(header.hash()),
      '0x88e96d4537bea4d9c05d12549907b32561d3bf31f45aae734cdc119f13406cb6',
      'correct PoW hash (sila-mainnet block 1)',
    )
