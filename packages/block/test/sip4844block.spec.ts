...
describe('SIP4844 header tests', () => {
  ...
  it('should work', () => {
    ...
    assert.throws(
      ...
      undefined,
      'should throw when setting excessBlobGas with SIP4844 not being activated',
    )
    ...
    }, 'correctly instantiates an SIP4844 block header')
...
describe('blob gas tests', () => {
  ...
  describe('SIP-7918: Blob base fee bounded by execution cost', () => {
    const osakaCommon = createCommonFromGethGenesis(sip4844GethGenesis, {
      chain: 'customChain',
      hardfork: Hardfork.SilaCancun,
      params: paramsBlock,
      customCrypto: { kzg },
    ...
    it('should use original SIP-4844 logic when reserve price condition is not met', () => {
      ...
      // Should use original SIP-4844 logic
      ...
      assert.strictEqual(
        ...
        'should use original SIP-4844 logic when reserve price condition is not met',
      )
    })

    it('should not apply SIP-7918 logic when SIP is not activated', () => {
      // Use SilaCancun hardfork where SIP-7918 is not activated
      const header = createBlockHeader(
        {
          number: 1,
      ...
      // Should use original SIP-4844 logic since SIP-7918 is not activated
      ...
      assert.strictEqual(
        excessBlobGas,
        expectedExcessBlobGas,
        'should use original SIP-4844 logic when SIP-7918 is not activated',
      )
    })
  })
})
...
describe('fake exponential', () => {
  it('should work', () => {
    // Test inputs borrowed from geth - https://github.com/mdehoog/go-sila/blob/a915d56f1d52906470ddce1bda7fa916044b6f95/consensus/misc/sip4844_test.go#L26
    const testInputs = [
      [1, 0, 1, 1],
      [38493, 0, 1000, 38493],
      [0, 1234, 2345, 0],
