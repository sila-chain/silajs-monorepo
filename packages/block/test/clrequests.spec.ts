...
import { CLRequestType, createCLRequest, equalsBytes, hexToBytes } from '@silajs/util'
import { sha256 } from '@noble/hashes/sha2.js'
import { assert, describe, it } from 'vitest'

import { createBlock, genRequestsRoot } from '../src/index.ts'

import type { CLRequest } from '@silajs/util'

describe('[Block]: CLRequests tests', () => {
  // Common with SIP-7685 enabled (CLRequests)
