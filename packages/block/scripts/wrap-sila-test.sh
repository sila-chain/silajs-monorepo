...
# Based on these instructions: https://github.com/sila-chain/silajs/silajs-block/issues/55
#
# Usage: 
# ./wrap-sila-test.sh "https://raw.githubusercontent.com/sila/tests/eea4bfbeec5524b2e2c0ff84c8a350fcb3edec23/BasicTests/difficultyEIP2384.json"
