...
/**
 * Offline sila-mainnet block replay.
 ...
 *
 * Usage: npx tsx examples/runSilaMainnetBlock.ts <blockNumber>
 * Example: npx tsx examples/runSilaMainnetBlock.ts 24476000
 *
 ...
 */
import { createBlockFromRPC } from '@silajs/block'
...
const main = async () => {
  ...
  if (blockNumber === undefined) {
    ...
    console.log('Usage: npx tsx examples/runSilaMainnetBlock.ts <blockNumber>')
