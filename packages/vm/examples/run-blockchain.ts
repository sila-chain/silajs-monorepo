...
import { Common, ConsensusAlgorithm, ConsensusType, SilaMainnet } from '@silajs/common'
import { Ethash } from '@silajs/ethash'
import { Address, bytesToHex, createAccount, hexToBytes, setLengthLeft } from '@silajs/util'
...
async function main() {
  const common = new Common({ chain: SilaMainnet, hardfork: blockchainMockData.network.toLowerCase() })
