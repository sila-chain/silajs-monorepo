...
[@silajs/vm](../README.md) / buildBlock

# Function: buildBlock()

> **buildBlock**(`vm`, `opts`): `Promise`\<[`BlockBuilder`](../classes/BlockBuilder.md)\>

Defined in: [vm/src/buildBlock.ts:473](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/vm/src/buildBlock.ts#L473)
