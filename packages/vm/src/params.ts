...
.  */
  ...
  /**
.  * Fee market change for SIL 1.0 chain
.  */
  1559: {
    // gasConfig
    elasticityMultiplier: 2, // Maximum block gas target elasticity
    initialBaseFee: 1000000000, // Initial base fee on first SIP1559 block
  },
  /**
...
.  */
  ...
  7251: {
    ...
    systemCallGasLimit: 30_000_000, // SIP-7251 system call gas limit
  },
  /**
.  * Shard Blob Transactions
.  */
