import { Block, createBlockHeader } from '@silajs/block'
...
import type { BlockOptions } from '@silajs/block'
 ...
 * @param {TxOptions} opts Tx opts that can include an @silajs/common object
...
export function getDAOCommon(activationBlock: number) {
  // here: get the default fork list of sila-mainnet and only edit the DAO fork block (thus copy the rest of the "default" hardfork settings)
  const defaultDAOCommon = new Common({ chain: SilaMainnet, hardfork: Hardfork.Dao })
