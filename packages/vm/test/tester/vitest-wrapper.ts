...
setEnv('VITE_FORK', argv.fork ?? env.VITE_FORK ?? 'SilaPrague')
...
setEnv('VITE_CUSTOM_STATE_TEST', argv.customStateTest)
...
setEnv('VITE_DATA', argv.data)
setEnv('VITE_GAS', argv.gas)
setEnv('VITE_VALUE', argv.value)
setEnv('VITE_REPS', argv.reps)
...
if (argv.jsontrace === true) setEnv('VITE_JSONTRACE', 'true')
