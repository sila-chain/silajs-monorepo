...
import { Address, bigIntToBytes, hexToBytes, setLengthLeft } from '@silajs/util'
...
/**
 * Tests taken from https://github.com/sila-chain/SIPs/blob/master/SIPS/sip-1283.md
 */
...
describe('Constantinople: SIP-1283', () => {
  it('net-metering SSTORE', async () => {
    ...
    for (const testCase of testCases) {
      ...
      try {
        const res = await vm.savm.runCall(runCallArgs)
