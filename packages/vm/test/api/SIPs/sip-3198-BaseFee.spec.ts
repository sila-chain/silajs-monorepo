...
import { FeeMarket1559Tx } from '@silajs/tx'
import { Address, Units, hexToBytes, privateToAddress } from '@silajs/util'
...
describe('SIP3198 tests', () => {
  it('test SIP3198 gas fee and correct value', async () => {
    // Initial base fee for SIP1559
    ...
    await vm.stateManager.modifyAccountFields(sender, { balance: Units.sila(1) })
