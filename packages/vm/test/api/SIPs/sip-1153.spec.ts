...
import { Account, Address, bytesToInt, hexToBytes, privateToAddress } from '@silajs/util'
...
describe('SIP 1153: transient storage', () => {
  const initialGas = BigInt(0xffffffffff)
  const common = new Common({ chain: SilaMainnet, hardfork: Hardfork.Berlin, sips: [1153] })
