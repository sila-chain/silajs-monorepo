...
describe('SIP 3541 tests', () => {
  const common = new Common({ chain: SilaMainnet, hardfork: Hardfork.Berlin, sips: [3541] })
  const commonNoEIP3541 = new Common({ chain: SilaMainnet, hardfork: Hardfork.Berlin, sips: [] })
  ...
  it('deposit 0xEF code if 3541 is active', async () => {
    ...
    // check if we can deposit a contract on non-SIP3541 chains
