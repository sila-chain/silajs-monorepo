...
import type { EOACode7702AuthorizationListBytesItem, PrefixedHexString } from '@silajs/util'
import { secp256k1 } from '@noble/curves/secp256k1.js'
import type { VM } from '../../../src/index.ts'

// SIP-7702 code designator. If code starts with these bytes, it is a 7702-delegated address
const sip7702Designator = hexToBytes('0xef01')
...
describe('SIP 7702: set code to EOA accounts', () => {
...
describe('test SIP-7702 opcodes', () => {
