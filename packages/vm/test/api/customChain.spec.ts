...
import type { AccountState, GenesisState } from '@silajs/common'
...
describe('VM initialized with custom state', () => {
  it('should transfer sil from already existent account', async () => {
  ...
  it('should retrieve value from storage', async () => {
    ...
    const callResult = await vm.savm.runCall({
