...
import { Block, createBlockFromRPC } from '@silajs/block'
import { Common, Hardfork, SilaMainnet } from '@silajs/common'
import { VM, createVM, runBlock as runBlockVM } from '@silajs/vm'
...
export async function sila-mainnetBlocks(suite?: Benchmark.Suite, numSamples?: number) {
  ...
  for (const blockData of data) {
    ...
    if ([9422909, 9422911, 9422912, 9422913, 9422914].includes(blockNumber)) {
      ...
      // https://github.com/sila-chain/silajs-monorepo/pull/1546
      continue
    }
