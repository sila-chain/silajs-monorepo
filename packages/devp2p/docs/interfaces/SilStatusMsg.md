...
[@silajs/devp2p](../README.md) / SilStatusMsg

# Interface: SilStatusMsg

Defined in: [packages/devp2p/src/protocol/sil.ts:25](https://github.com/sila-chain/silajs-monorepo/blob/master/packages/devp2p/src/protocol/sil.ts#L25)
