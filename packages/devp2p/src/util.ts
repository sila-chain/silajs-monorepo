...
import type { SilStatusMsg } from './protocol/sil.ts'

// Do not use :# here, no logging without sub namespace occurring and current code structure
// otherwise creates loggers like `devp2p:#:sil`
...
type assertInput = Uint8Array | Uint8Array[] | SilStatusMsg | number | null
...
export function assertEq(
  ...
  if (expected instanceof Uint8Array && actual instanceof Uint8Array) {
    ...
    throw SilaJSErrorWithoutCode(fullMsg)
  }
