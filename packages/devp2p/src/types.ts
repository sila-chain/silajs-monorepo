...
import type { NestedUint8Array } from '@silajs/rlp'
import type { DPT } from './dpt/index.ts'
import type { SilMessageCodes } from './protocol/sil.ts'
...
export interface ProtocolEvent {
  message: [code: SnapMessageCodes | SilMessageCodes, payload: Uint8Array | NestedUint8Array]
  status: {
